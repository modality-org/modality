...
curl --proto '=https' --tlsv1.2 -sSf \
  https://get.modality.org/testnet/latest/install.sh | sh
```
...
- **Linux x86_64**: `https://get.modality.org/testnet/latest/binaries/linux-x86_64/modality`
- **macOS ARM64**: `https://get.modality.org/testnet/latest/binaries/darwin-aarch64/modality`
- **Windows**: `https://get.modality.org/testnet/latest/binaries/windows-x86_64/modality.exe`
...
```bash
cargo install --index \
  sparse+https://get.modality.org/testnet/latest/cargo-registry/index/ \
  modality
```
