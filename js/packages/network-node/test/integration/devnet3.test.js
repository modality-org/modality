  ...
  it(
    ...
    async () => {
      node1 = await Node.fromConfigFilepath(
        `${FIXTURES_COMMON}/network-node-configs/devnet3/node1.json`,
        { storage_path: null }
      );
      node2 = await Node.fromConfigFilepath(
        `${FIXTURES_COMMON}/network-node-configs/devnet3/node2.json`,
        { storage_path: null }
      );
      node3 = await Node.fromConfigFilepath(
        `${FIXTURES_COMMON}/network-node-configs/devnet3/node3.json`,
        { storage_path: null }
      );
      try {
