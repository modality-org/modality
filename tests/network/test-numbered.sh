...
# Runs each numbered example's test suite (01-09) in sequence
...
run_test_suite "01-ping-node" "01 - Ping Node" "quick"
run_test_suite "02-run-devnet1" "02 - Run Devnet1" "quick"
run_test_suite "04-sync-miner-blocks" "04 - Sync Miner Blocks" "quick"
run_test_suite "06-contract-lifecycle" "06 - Contract Lifecycle" "quick"
run_test_suite "07-contract-assets" "07 - Contract Assets" "quick"
run_test_suite "08-network-partition" "08 - Network Partition" "quick"
run_test_suite "09-network-parameters" "09 - Network Parameters" "quick"

# Normal tests (moderate duration)
run_test_suite "03-run-devnet3" "03 - Run Devnet3" "normal"

# Slow tests (long running, might timeout in CI)
run_test_suite "05-mining" "05 - Mining" "slow"
