...
required_patterns=(
  ...
  "\`README.txt\`"
  "plus \`PROVENANCE.txt\` and \`SHA256SUMS\`"
  "unpacks it"
  "verifies the"
  "checksum manifest"
  "manifest covers exactly \`bin/modal\`"
  "\`README.txt\`, and \`PROVENANCE.txt\`"
  "provenance file records the source"
  "revision, version, profile, features, platform, and expected help surface"
