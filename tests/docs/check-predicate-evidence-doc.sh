...
required_patterns=(
  ...
  "\`text_eq\` from accepted-state strings"
  "predicate-test inputs remain explicit JSON"
...
language_patterns=(
  ...
  "\`text_eq\`, \`amount_in_range\`, \`bool_true\`, and \`bool_false\` are enforced from replayable commit artifacts."
