...
required_patterns=(
  ...
  "do not see JSON, text, or numbers written by the same pending commit."
  "same pending commit"
  ...
  "and \`text_eq\` from accepted-state strings"
...
language_patterns=(
  ...
  "\`text_eq\`, and \`amount_in_range\` are enforced from replayable commit artifacts."
