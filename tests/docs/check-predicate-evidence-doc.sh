...
required_patterns=(
  ...
  "validator predicate executor"
  "explicit replay-evidence"
  "handoff that injects"
  "only when that input already carries \`replay_bundle_json\`"
  "requires that replay-bound input to be a JSON object"
  "explicit predicate-supplied key map instead of overwriting it"
  "contract processor now has a replay-state-aware"
  "parent commit's accepted-state oracle-key map"
  "sequenced parent chain"
  "routes replay-bundle predicate input through that"
  ...
  "This"
  "extension-level"
  "contract-log replay supplies replay bundles end to end"
...
wasm_patterns=(
  ...
  "validator predicate executor now also has"
  "explicit"
  "replay-evidence handoff"
  "preserves any explicit predicate-supplied key map"
  "contract processor now has a replay-state-aware"
  "parent commit's accepted-state"
  "sequenced parent chain"
  "routes replay-bundle"
