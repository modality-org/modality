...
reject uppercase or overlong expected revision tokens before replay evidence can pass.
...
matches the single source revision recorded by provenance; uppercase revision
markers are rejected as non-canonical before installer evidence is accepted.
...
The producer and downloaded-artifact verifier also reject uppercase expected
or overlong revision tokens before replay evidence can pass.
