...
benchmark crosswalk keeps the abstract `newOrder`, authorization-validation,
and finalize fixture distinct from the path-write corpus, runs the first-contract
