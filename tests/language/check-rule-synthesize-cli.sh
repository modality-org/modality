...
required_unsat_review_patterns=(
  ...
  "Prompt-to-facts trace: not automatic; review preserved clauses against parser-backed formulas"
  "Source facts preserved: no"
  "Source facts preserved count: 0"
  "Malformed source facts flagged: 0"
  "Path-write source facts flagged: 0"
  "External assumptions preserved: no"
  "External assumptions preserved count: 0"
