...
required_review_patterns=(
  ...
  'Line 2 [path-write template]: `+sets(/orders/{order}/csr)`'
  'Line 4 [path-write template]: `+sets(/orders/{order}/status)`'
  ...
  "Source facts preserved count: 4"
  "Malformed source facts flagged: 0"
  "Path-write source facts flagged: 4"
  "External assumptions preserved: yes"
  "External assumptions preserved count: 1"
  "Commit evidence assumptions flagged: 0"
  "External-world assumptions flagged: 1"
  "Reviewer assumptions flagged: 0"
  "Parser-backed formulas: 4"
  "Verifier result: passed"
  "Assumptions section present: yes"
  "Known gaps section present: yes"
  "## Verifier Result"
