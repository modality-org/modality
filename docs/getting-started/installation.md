...
and downloaded-artifact verifier both reject too-short, uppercase, or overlong
expected revision tokens before replay evidence can pass. Set
...
characters. They also reject too-short, uppercase, or overlong expected revision tokens
