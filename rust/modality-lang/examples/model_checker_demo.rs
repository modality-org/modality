use modality_lang::{
    ast::{Model, Part, PartState, Property, PropertySign, Transition},
    parse_all_formulas_content_lalrpop, ModelChecker,
};
...
"#;
    ...
    // Test <+blue> true
    let diamond_blue_true = formulas
        .iter()
    ...
    let blue_yellow_test1 = formulas
        .iter()
    ...
    // Test <+blue +yellow> true
    let blue_yellow_test2 = formulas
        .iter()
