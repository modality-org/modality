        ...
        FormulaExpr::Implies(lhs, rhs) => {
            ...
            if !guarded_actions.is_empty() {
                ...
                if !signer_props.is_empty() {
                    for committed_props in extract_eventually_diamond_box_prop_groups(rhs)
                        .into_iter()
                        .filter(|props| props.iter().any(is_positive_action_property))
                    {
                        let mut props = signer_props.clone();
                        for prop in committed_props {
...
mod tests {
    ...
    #[test]
    fn test_committed_signer_with_predicated_goal_keeps_full_goal_available() {
        let formula = FormulaExpr::Implies(
            Box::new(FormulaExpr::Box(
                vec![Property::new(PropertySign::Plus, "RELEASE".to_string())],
                Box::new(FormulaExpr::True),
    ...
    #[test]
    fn test_gfp_preserves_committed_availability_with_prop_recursion() {
        let formula = FormulaExpr::Gfp(
            "X".to_string(),
            Box::new(FormulaExpr::And(
                Box::new(FormulaExpr::DiamondBox(
    ...
    #[test]
    fn test_gfp_preserves_committed_availability_with_parenthesized_prop_recursion() {
        let formula = FormulaExpr::Gfp(
            "X".to_string(),
            Box::new(FormulaExpr::And(
                Box::new(FormulaExpr::DiamondBox(
    ...
    #[test]
    fn test_gfp_preserves_permissive_availability_before_prop_recursion() {
        let formula = FormulaExpr::Gfp(
            "X".to_string(),
            Box::new(FormulaExpr::And(
                Box::new(FormulaExpr::Box(
    ...
    #[test]
    fn test_gfp_preserves_permissive_availability_before_parenthesized_prop_recursion() {
        let formula = FormulaExpr::Gfp(
            "X".to_string(),
            Box::new(FormulaExpr::And(
                Box::new(FormulaExpr::Box(
    ...
    #[test]
    fn test_lfp_nested_until_guard_with_prop_recursion_preserves_goal_availability() {
        let formula = FormulaExpr::Lfp(
            "X".to_string(),
            Box::new(FormulaExpr::Or(
                Box::new(FormulaExpr::DiamondBox(
    ...
    #[test]
    fn test_lfp_nested_until_guard_with_committed_recursion_preserves_goal_availability() {
        let formula = FormulaExpr::Lfp(
            "X".to_string(),
            Box::new(FormulaExpr::Or(
                Box::new(FormulaExpr::DiamondBox(
