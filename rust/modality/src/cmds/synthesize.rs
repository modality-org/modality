...
const FORMULA_EXAMPLE_GROUPS: &[FormulaExampleGroup] = &[
    ...
    FormulaExampleGroup {
        ...
        formulas: &[
            ...
            r#"always([+REQUEST_AGENT_BENCHMARK_CHANGE] true -> eventually(<+RUN_AGENT_BENCHMARK> true))"#,
            r#"always([+RUN_AGENT_BENCHMARK] true -> eventually(<+APPROVE_AGENT_BENCHMARK_CHANGE> true))"#,
            r#"always([+APPROVE_AGENT_BENCHMARK_CHANGE] true -> eventually(<+APPLY_AGENT_BENCHMARK> true))"#,
            ...
            r#"always([+REQUEST_AGENT_ALERT_RULE_CHANGE] true -> eventually(<+REVIEW_AGENT_ALERT_RULE> true))"#,
            r#"always([+REVIEW_AGENT_ALERT_RULE] true -> eventually(<+APPROVE_AGENT_ALERT_RULE_CHANGE> true))"#,
            r#"always([+APPROVE_AGENT_ALERT_RULE_CHANGE] true -> eventually(<+APPLY_AGENT_ALERT_RULE> true))"#,
            r#"always([+REQUEST_AGENT_ESCALATION_POLICY_CHANGE] true -> eventually(<+REVIEW_AGENT_ESCALATION_POLICY> true))"#,
            r#"always([+REVIEW_AGENT_ESCALATION_POLICY] true -> eventually(<+APPROVE_AGENT_ESCALATION_POLICY_CHANGE> true))"#,
            r#"always([+APPROVE_AGENT_ESCALATION_POLICY_CHANGE] true -> eventually(<+APPLY_AGENT_ESCALATION_POLICY> true))"#,
            r#"always([+REQUEST_AGENT_NOTIFICATION_POLICY_CHANGE] true -> eventually(<+REVIEW_AGENT_NOTIFICATION_POLICY> true))"#,
            r#"always([+REVIEW_AGENT_NOTIFICATION_POLICY] true -> eventually(<+APPROVE_AGENT_NOTIFICATION_POLICY_CHANGE> true))"#,
            r#"always([+APPROVE_AGENT_NOTIFICATION_POLICY_CHANGE] true -> eventually(<+APPLY_AGENT_NOTIFICATION_POLICY> true))"#,
            r#"always([+REQUEST_AGENT_HEARTBEAT_POLICY_CHANGE] true -> eventually(<+REVIEW_AGENT_HEARTBEAT_POLICY> true))"#,
            r#"always([+REVIEW_AGENT_HEARTBEAT_POLICY] true -> eventually(<+APPROVE_AGENT_HEARTBEAT_POLICY_CHANGE> true))"#,
            r#"always([+APPROVE_AGENT_HEARTBEAT_POLICY_CHANGE] true -> eventually(<+APPLY_AGENT_HEARTBEAT_POLICY> true))"#,
            ...
            r#"always([+REQUEST_AGENT_REMINDER_POLICY_CHANGE] true -> eventually(<+REVIEW_AGENT_REMINDER_POLICY> true))"#,
            r#"always([+REVIEW_AGENT_REMINDER_POLICY] true -> eventually(<+APPROVE_AGENT_REMINDER_POLICY_CHANGE> true))"#,
            r#"always([+APPROVE_AGENT_REMINDER_POLICY_CHANGE] true -> eventually(<+APPLY_AGENT_REMINDER_POLICY> true))"#,
            ...
            r#"always([+REQUEST_DECISION_DISCLOSURE] true -> eventually(<+REVIEW_DECISION_DISCLOSURE_SCOPE> true))"#,
            r#"always([+REVIEW_DECISION_DISCLOSURE_SCOPE] true -> eventually(<+APPROVE_DECISION_DISCLOSURE> true))"#,
            r#"always([+APPROVE_DECISION_DISCLOSURE] true -> eventually(<+DELIVER_DECISION_DISCLOSURE> true))"#,
            r#"always([+REQUEST_DECISION_PORTABILITY] true -> eventually(<+VERIFY_DECISION_PORTABILITY_SCOPE> true))"#,
            r#"always([+VERIFY_DECISION_PORTABILITY_SCOPE] true -> eventually(<+APPROVE_DECISION_PORTABILITY> true))"#,
            r#"always([+APPROVE_DECISION_PORTABILITY] true -> eventually(<+DELIVER_DECISION_PORTABILITY_PACKAGE> true))"#,
            ...
            r#"always([+REQUEST_DECISION_TRANSPARENCY_REVIEW] true -> eventually(<+COLLECT_DECISION_TRANSPARENCY_EVIDENCE> true))"#,
            r#"always([+COLLECT_DECISION_TRANSPARENCY_EVIDENCE] true -> eventually(<+APPROVE_DECISION_TRANSPARENCY> true))"#,
            r#"always([+APPROVE_DECISION_TRANSPARENCY] true -> eventually(<+PUBLISH_DECISION_TRANSPARENCY_REPORT> true))"#,
            ...
            r#"always([+REQUEST_DECISION_THRESHOLD_REVIEW] true -> eventually(<+ANALYZE_DECISION_THRESHOLDS> true))"#,
            r#"always([+ANALYZE_DECISION_THRESHOLDS] true -> eventually(<+APPROVE_DECISION_THRESHOLD_UPDATE> true))"#,
            r#"always([+APPROVE_DECISION_THRESHOLD_UPDATE] true -> eventually(<+RECORD_DECISION_THRESHOLD> true))"#,
            ...
            r#"always([+REQUEST_DECISION_RELIABILITY_REVIEW] true -> eventually(<+MEASURE_DECISION_RELIABILITY> true))"#,
            r#"always([+MEASURE_DECISION_RELIABILITY] true -> eventually(<+APPROVE_DECISION_RELIABILITY_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_RELIABILITY_REPORT] true -> eventually(<+PUBLISH_DECISION_RELIABILITY_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_ROBUSTNESS_REVIEW] true -> eventually(<+TEST_DECISION_ROBUSTNESS> true))"#,
            r#"always([+TEST_DECISION_ROBUSTNESS] true -> eventually(<+APPROVE_DECISION_ROBUSTNESS_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_ROBUSTNESS_REPORT] true -> eventually(<+PUBLISH_DECISION_ROBUSTNESS_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_CONSISTENCY_REVIEW] true -> eventually(<+COMPARE_DECISION_CONSISTENCY> true))"#,
            r#"always([+COMPARE_DECISION_CONSISTENCY] true -> eventually(<+APPROVE_DECISION_CONSISTENCY_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_CONSISTENCY_REPORT] true -> eventually(<+PUBLISH_DECISION_CONSISTENCY_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_ACCURACY_REVIEW] true -> eventually(<+MEASURE_DECISION_ACCURACY> true))"#,
            r#"always([+MEASURE_DECISION_ACCURACY] true -> eventually(<+APPROVE_DECISION_ACCURACY_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_ACCURACY_REPORT] true -> eventually(<+PUBLISH_DECISION_ACCURACY_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_PRECISION_REVIEW] true -> eventually(<+MEASURE_DECISION_PRECISION> true))"#,
            r#"always([+MEASURE_DECISION_PRECISION] true -> eventually(<+APPROVE_DECISION_PRECISION_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_PRECISION_REPORT] true -> eventually(<+PUBLISH_DECISION_PRECISION_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_RECALL_REVIEW] true -> eventually(<+MEASURE_DECISION_RECALL> true))"#,
            r#"always([+MEASURE_DECISION_RECALL] true -> eventually(<+APPROVE_DECISION_RECALL_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_RECALL_REPORT] true -> eventually(<+PUBLISH_DECISION_RECALL_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_SPECIFICITY_REVIEW] true -> eventually(<+MEASURE_DECISION_SPECIFICITY> true))"#,
            r#"always([+MEASURE_DECISION_SPECIFICITY] true -> eventually(<+APPROVE_DECISION_SPECIFICITY_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_SPECIFICITY_REPORT] true -> eventually(<+PUBLISH_DECISION_SPECIFICITY_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_SENSITIVITY_REVIEW] true -> eventually(<+MEASURE_DECISION_SENSITIVITY> true))"#,
            r#"always([+MEASURE_DECISION_SENSITIVITY] true -> eventually(<+APPROVE_DECISION_SENSITIVITY_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_SENSITIVITY_REPORT] true -> eventually(<+PUBLISH_DECISION_SENSITIVITY_REPORT> true))"#,
            ...
            r#"always([+REQUEST_DECISION_INCIDENCE_REVIEW] true -> eventually(<+MEASURE_DECISION_INCIDENCE> true))"#,
            r#"always([+MEASURE_DECISION_INCIDENCE] true -> eventually(<+APPROVE_DECISION_INCIDENCE_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_INCIDENCE_REPORT] true -> eventually(<+PUBLISH_DECISION_INCIDENCE_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_LIFT_REVIEW] true -> eventually(<+MEASURE_DECISION_LIFT> true))"#,
            r#"always([+MEASURE_DECISION_LIFT] true -> eventually(<+APPROVE_DECISION_LIFT_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_LIFT_REPORT] true -> eventually(<+PUBLISH_DECISION_LIFT_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_GAIN_REVIEW] true -> eventually(<+MEASURE_DECISION_GAIN> true))"#,
            r#"always([+MEASURE_DECISION_GAIN] true -> eventually(<+APPROVE_DECISION_GAIN_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_GAIN_REPORT] true -> eventually(<+PUBLISH_DECISION_GAIN_REPORT> true))"#,
            ...
            r#"always([+REQUEST_DECISION_RISK_REVIEW] true -> eventually(<+MEASURE_DECISION_RISK> true))"#,
            r#"always([+MEASURE_DECISION_RISK] true -> eventually(<+APPROVE_DECISION_RISK_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_RISK_REPORT] true -> eventually(<+PUBLISH_DECISION_RISK_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_EXPOSURE_REVIEW] true -> eventually(<+MEASURE_DECISION_EXPOSURE> true))"#,
            r#"always([+MEASURE_DECISION_EXPOSURE] true -> eventually(<+APPROVE_DECISION_EXPOSURE_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_EXPOSURE_REPORT] true -> eventually(<+PUBLISH_DECISION_EXPOSURE_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_HARM_REVIEW] true -> eventually(<+MEASURE_DECISION_HARM> true))"#,
            r#"always([+MEASURE_DECISION_HARM] true -> eventually(<+APPROVE_DECISION_HARM_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_HARM_REPORT] true -> eventually(<+PUBLISH_DECISION_HARM_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_LOSS_REVIEW] true -> eventually(<+MEASURE_DECISION_LOSS> true))"#,
            r#"always([+MEASURE_DECISION_LOSS] true -> eventually(<+APPROVE_DECISION_LOSS_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_LOSS_REPORT] true -> eventually(<+PUBLISH_DECISION_LOSS_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_SEVERITY_REVIEW] true -> eventually(<+MEASURE_DECISION_SEVERITY> true))"#,
            r#"always([+MEASURE_DECISION_SEVERITY] true -> eventually(<+APPROVE_DECISION_SEVERITY_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_SEVERITY_REPORT] true -> eventually(<+PUBLISH_DECISION_SEVERITY_REPORT> true))"#,
            ...
            r#"always([+REQUEST_DECISION_VALUE_REVIEW] true -> eventually(<+MEASURE_DECISION_VALUE> true))"#,
            r#"always([+MEASURE_DECISION_VALUE] true -> eventually(<+APPROVE_DECISION_VALUE_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_VALUE_REPORT] true -> eventually(<+PUBLISH_DECISION_VALUE_REPORT> true))"#,
            ...
            r#"always([+REQUEST_DECISION_RANK_REVIEW] true -> eventually(<+MEASURE_DECISION_RANK> true))"#,
            r#"always([+MEASURE_DECISION_RANK] true -> eventually(<+APPROVE_DECISION_RANK_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_RANK_REPORT] true -> eventually(<+PUBLISH_DECISION_RANK_REPORT> true))"#,
            ...
            r#"always([+REQUEST_DECISION_INFLUENCE_REVIEW] true -> eventually(<+MEASURE_DECISION_INFLUENCE> true))"#,
            r#"always([+MEASURE_DECISION_INFLUENCE] true -> eventually(<+APPROVE_DECISION_INFLUENCE_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_INFLUENCE_REPORT] true -> eventually(<+PUBLISH_DECISION_INFLUENCE_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_CONTRIBUTION_REVIEW] true -> eventually(<+MEASURE_DECISION_CONTRIBUTION> true))"#,
            r#"always([+MEASURE_DECISION_CONTRIBUTION] true -> eventually(<+APPROVE_DECISION_CONTRIBUTION_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_CONTRIBUTION_REPORT] true -> eventually(<+PUBLISH_DECISION_CONTRIBUTION_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_IMPORTANCE_REVIEW] true -> eventually(<+MEASURE_DECISION_IMPORTANCE> true))"#,
            r#"always([+MEASURE_DECISION_IMPORTANCE] true -> eventually(<+APPROVE_DECISION_IMPORTANCE_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_IMPORTANCE_REPORT] true -> eventually(<+PUBLISH_DECISION_IMPORTANCE_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_SALIENCE_REVIEW] true -> eventually(<+MEASURE_DECISION_SALIENCE> true))"#,
            r#"always([+MEASURE_DECISION_SALIENCE] true -> eventually(<+APPROVE_DECISION_SALIENCE_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_SALIENCE_REPORT] true -> eventually(<+PUBLISH_DECISION_SALIENCE_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_RELEVANCE_REVIEW] true -> eventually(<+MEASURE_DECISION_RELEVANCE> true))"#,
            r#"always([+MEASURE_DECISION_RELEVANCE] true -> eventually(<+APPROVE_DECISION_RELEVANCE_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_RELEVANCE_REPORT] true -> eventually(<+PUBLISH_DECISION_RELEVANCE_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_PERTINENCE_REVIEW] true -> eventually(<+MEASURE_DECISION_PERTINENCE> true))"#,
            r#"always([+MEASURE_DECISION_PERTINENCE] true -> eventually(<+APPROVE_DECISION_PERTINENCE_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_PERTINENCE_REPORT] true -> eventually(<+PUBLISH_DECISION_PERTINENCE_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_APPLICABILITY_REVIEW] true -> eventually(<+MEASURE_DECISION_APPLICABILITY> true))"#,
            r#"always([+MEASURE_DECISION_APPLICABILITY] true -> eventually(<+APPROVE_DECISION_APPLICABILITY_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_APPLICABILITY_REPORT] true -> eventually(<+PUBLISH_DECISION_APPLICABILITY_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_SUITABILITY_REVIEW] true -> eventually(<+MEASURE_DECISION_SUITABILITY> true))"#,
            r#"always([+MEASURE_DECISION_SUITABILITY] true -> eventually(<+APPROVE_DECISION_SUITABILITY_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_SUITABILITY_REPORT] true -> eventually(<+PUBLISH_DECISION_SUITABILITY_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_APPROPRIATENESS_REVIEW] true -> eventually(<+MEASURE_DECISION_APPROPRIATENESS> true))"#,
            r#"always([+MEASURE_DECISION_APPROPRIATENESS] true -> eventually(<+APPROVE_DECISION_APPROPRIATENESS_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_APPROPRIATENESS_REPORT] true -> eventually(<+PUBLISH_DECISION_APPROPRIATENESS_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_ADEQUACY_REVIEW] true -> eventually(<+MEASURE_DECISION_ADEQUACY> true))"#,
            r#"always([+MEASURE_DECISION_ADEQUACY] true -> eventually(<+APPROVE_DECISION_ADEQUACY_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_ADEQUACY_REPORT] true -> eventually(<+PUBLISH_DECISION_ADEQUACY_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_SUFFICIENCY_REVIEW] true -> eventually(<+MEASURE_DECISION_SUFFICIENCY> true))"#,
            r#"always([+MEASURE_DECISION_SUFFICIENCY] true -> eventually(<+APPROVE_DECISION_SUFFICIENCY_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_SUFFICIENCY_REPORT] true -> eventually(<+PUBLISH_DECISION_SUFFICIENCY_REPORT> true))"#,
            ...
            r#"always([+REQUEST_DECISION_SCOPE_REVIEW] true -> eventually(<+MEASURE_DECISION_SCOPE> true))"#,
            r#"always([+MEASURE_DECISION_SCOPE] true -> eventually(<+APPROVE_DECISION_SCOPE_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_SCOPE_REPORT] true -> eventually(<+PUBLISH_DECISION_SCOPE_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_RANGE_REVIEW] true -> eventually(<+MEASURE_DECISION_RANGE> true))"#,
            r#"always([+MEASURE_DECISION_RANGE] true -> eventually(<+APPROVE_DECISION_RANGE_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_RANGE_REPORT] true -> eventually(<+PUBLISH_DECISION_RANGE_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_BOUNDS_REVIEW] true -> eventually(<+MEASURE_DECISION_BOUNDS> true))"#,
            r#"always([+MEASURE_DECISION_BOUNDS] true -> eventually(<+APPROVE_DECISION_BOUNDS_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_BOUNDS_REPORT] true -> eventually(<+PUBLISH_DECISION_BOUNDS_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_BOUNDARIES_REVIEW] true -> eventually(<+MEASURE_DECISION_BOUNDARIES> true))"#,
            r#"always([+MEASURE_DECISION_BOUNDARIES] true -> eventually(<+APPROVE_DECISION_BOUNDARIES_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_BOUNDARIES_REPORT] true -> eventually(<+PUBLISH_DECISION_BOUNDARIES_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_CRITERIA_REVIEW] true -> eventually(<+MEASURE_DECISION_CRITERIA> true))"#,
            r#"always([+MEASURE_DECISION_CRITERIA] true -> eventually(<+APPROVE_DECISION_CRITERIA_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_CRITERIA_REPORT] true -> eventually(<+PUBLISH_DECISION_CRITERIA_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_CONDITIONS_REVIEW] true -> eventually(<+MEASURE_DECISION_CONDITIONS> true))"#,
            r#"always([+MEASURE_DECISION_CONDITIONS] true -> eventually(<+APPROVE_DECISION_CONDITIONS_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_CONDITIONS_REPORT] true -> eventually(<+PUBLISH_DECISION_CONDITIONS_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_LIMITS_REVIEW] true -> eventually(<+MEASURE_DECISION_LIMITS> true))"#,
            r#"always([+MEASURE_DECISION_LIMITS] true -> eventually(<+APPROVE_DECISION_LIMITS_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_LIMITS_REPORT] true -> eventually(<+PUBLISH_DECISION_LIMITS_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_CONSTRAINTS_REVIEW] true -> eventually(<+MEASURE_DECISION_CONSTRAINTS> true))"#,
            r#"always([+MEASURE_DECISION_CONSTRAINTS] true -> eventually(<+APPROVE_DECISION_CONSTRAINTS_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_CONSTRAINTS_REPORT] true -> eventually(<+PUBLISH_DECISION_CONSTRAINTS_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_RESTRICTIONS_REVIEW] true -> eventually(<+MEASURE_DECISION_RESTRICTIONS> true))"#,
            r#"always([+MEASURE_DECISION_RESTRICTIONS] true -> eventually(<+APPROVE_DECISION_RESTRICTIONS_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_RESTRICTIONS_REPORT] true -> eventually(<+PUBLISH_DECISION_RESTRICTIONS_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_REQUIREMENTS_REVIEW] true -> eventually(<+MEASURE_DECISION_REQUIREMENTS> true))"#,
            r#"always([+MEASURE_DECISION_REQUIREMENTS] true -> eventually(<+APPROVE_DECISION_REQUIREMENTS_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_REQUIREMENTS_REPORT] true -> eventually(<+PUBLISH_DECISION_REQUIREMENTS_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_SPECIFICATIONS_REVIEW] true -> eventually(<+MEASURE_DECISION_SPECIFICATIONS> true))"#,
            r#"always([+MEASURE_DECISION_SPECIFICATIONS] true -> eventually(<+APPROVE_DECISION_SPECIFICATIONS_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_SPECIFICATIONS_REPORT] true -> eventually(<+PUBLISH_DECISION_SPECIFICATIONS_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_PARAMETERS_REVIEW] true -> eventually(<+MEASURE_DECISION_PARAMETERS> true))"#,
            r#"always([+MEASURE_DECISION_PARAMETERS] true -> eventually(<+APPROVE_DECISION_PARAMETERS_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_PARAMETERS_REPORT] true -> eventually(<+PUBLISH_DECISION_PARAMETERS_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_SETTINGS_REVIEW] true -> eventually(<+MEASURE_DECISION_SETTINGS> true))"#,
            r#"always([+MEASURE_DECISION_SETTINGS] true -> eventually(<+APPROVE_DECISION_SETTINGS_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_SETTINGS_REPORT] true -> eventually(<+PUBLISH_DECISION_SETTINGS_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_CONFIGURATION_REVIEW] true -> eventually(<+MEASURE_DECISION_CONFIGURATION> true))"#,
            r#"always([+MEASURE_DECISION_CONFIGURATION] true -> eventually(<+APPROVE_DECISION_CONFIGURATION_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_CONFIGURATION_REPORT] true -> eventually(<+PUBLISH_DECISION_CONFIGURATION_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_PREFERENCE_REVIEW] true -> eventually(<+MEASURE_DECISION_PREFERENCE> true))"#,
            r#"always([+MEASURE_DECISION_PREFERENCE] true -> eventually(<+APPROVE_DECISION_PREFERENCE_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_PREFERENCE_REPORT] true -> eventually(<+PUBLISH_DECISION_PREFERENCE_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_OPTION_REVIEW] true -> eventually(<+MEASURE_DECISION_OPTION> true))"#,
            r#"always([+MEASURE_DECISION_OPTION] true -> eventually(<+APPROVE_DECISION_OPTION_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_OPTION_REPORT] true -> eventually(<+PUBLISH_DECISION_OPTION_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_ALTERNATIVE_REVIEW] true -> eventually(<+MEASURE_DECISION_ALTERNATIVE> true))"#,
            r#"always([+MEASURE_DECISION_ALTERNATIVE] true -> eventually(<+APPROVE_DECISION_ALTERNATIVE_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_ALTERNATIVE_REPORT] true -> eventually(<+PUBLISH_DECISION_ALTERNATIVE_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_CHOICE_REVIEW] true -> eventually(<+MEASURE_DECISION_CHOICE> true))"#,
            r#"always([+MEASURE_DECISION_CHOICE] true -> eventually(<+APPROVE_DECISION_CHOICE_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_CHOICE_REPORT] true -> eventually(<+PUBLISH_DECISION_CHOICE_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_SELECTION_REVIEW] true -> eventually(<+MEASURE_DECISION_SELECTION> true))"#,
            r#"always([+MEASURE_DECISION_SELECTION] true -> eventually(<+APPROVE_DECISION_SELECTION_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_SELECTION_REPORT] true -> eventually(<+PUBLISH_DECISION_SELECTION_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_RECOMMENDATION_REVIEW] true -> eventually(<+MEASURE_DECISION_RECOMMENDATION> true))"#,
            r#"always([+MEASURE_DECISION_RECOMMENDATION] true -> eventually(<+APPROVE_DECISION_RECOMMENDATION_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_RECOMMENDATION_REPORT] true -> eventually(<+PUBLISH_DECISION_RECOMMENDATION_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_PROPOSAL_REVIEW] true -> eventually(<+MEASURE_DECISION_PROPOSAL> true))"#,
            r#"always([+MEASURE_DECISION_PROPOSAL] true -> eventually(<+APPROVE_DECISION_PROPOSAL_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_PROPOSAL_REPORT] true -> eventually(<+PUBLISH_DECISION_PROPOSAL_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_SUBMISSION_REVIEW] true -> eventually(<+MEASURE_DECISION_SUBMISSION> true))"#,
            r#"always([+MEASURE_DECISION_SUBMISSION] true -> eventually(<+APPROVE_DECISION_SUBMISSION_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_SUBMISSION_REPORT] true -> eventually(<+PUBLISH_DECISION_SUBMISSION_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_DOCUMENT_REVIEW] true -> eventually(<+MEASURE_DECISION_DOCUMENT> true))"#,
            r#"always([+MEASURE_DECISION_DOCUMENT] true -> eventually(<+APPROVE_DECISION_DOCUMENT_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_DOCUMENT_REPORT] true -> eventually(<+PUBLISH_DECISION_DOCUMENT_REPORT> true))"#,
            r#"always([+REQUEST_DECISION_REPORT_REVIEW] true -> eventually(<+MEASURE_DECISION_REPORT> true))"#,
            r#"always([+MEASURE_DECISION_REPORT] true -> eventually(<+APPROVE_DECISION_REPORT> true))"#,
            r#"always([+APPROVE_DECISION_REPORT] true -> eventually(<+PUBLISH_DECISION_REPORT> true))"#,
            ...
            r#"always([+REQUEST_DECISION_MINUTES_REVIEW] true -> eventually(<+MEASURE_DECISION_MINUTES> true))"#,
            r#"always([+MEASURE_DECISION_MINUTES] true -> eventually(<+APPROVE_DECISION_MINUTES> true))"#,
            r#"always([+APPROVE_DECISION_MINUTES] true -> eventually(<+PUBLISH_DECISION_MINUTES> true))"#,
            r#"always([+REQUEST_DECISION_TRANSCRIPT_REVIEW] true -> eventually(<+MEASURE_DECISION_TRANSCRIPT> true))"#,
            r#"always([+MEASURE_DECISION_TRANSCRIPT] true -> eventually(<+APPROVE_DECISION_TRANSCRIPT> true))"#,
            r#"always([+APPROVE_DECISION_TRANSCRIPT] true -> eventually(<+PUBLISH_DECISION_TRANSCRIPT> true))"#,
            ...
            r#"always([+REQUEST_DECISION_CATALOG_REVIEW] true -> eventually(<+MEASURE_DECISION_CATALOG> true))"#,
            r#"always([+MEASURE_DECISION_CATALOG] true -> eventually(<+APPROVE_DECISION_CATALOG> true))"#,
            r#"always([+APPROVE_DECISION_CATALOG] true -> eventually(<+PUBLISH_DECISION_CATALOG> true))"#,
            r#"always([+REQUEST_DECISION_INVENTORY_REVIEW] true -> eventually(<+MEASURE_DECISION_INVENTORY> true))"#,
            r#"always([+MEASURE_DECISION_INVENTORY] true -> eventually(<+APPROVE_DECISION_INVENTORY> true))"#,
            r#"always([+APPROVE_DECISION_INVENTORY] true -> eventually(<+PUBLISH_DECISION_INVENTORY> true))"#,
            r#"always([+REQUEST_DECISION_REGISTRY_REVIEW] true -> eventually(<+MEASURE_DECISION_REGISTRY> true))"#,
            r#"always([+MEASURE_DECISION_REGISTRY] true -> eventually(<+APPROVE_DECISION_REGISTRY> true))"#,
            r#"always([+APPROVE_DECISION_REGISTRY] true -> eventually(<+PUBLISH_DECISION_REGISTRY> true))"#,
            r#"always([+REQUEST_DECISION_LEDGER_REVIEW] true -> eventually(<+MEASURE_DECISION_LEDGER> true))"#,
            r#"always([+MEASURE_DECISION_LEDGER] true -> eventually(<+APPROVE_DECISION_LEDGER> true))"#,
            r#"always([+APPROVE_DECISION_LEDGER] true -> eventually(<+PUBLISH_DECISION_LEDGER> true))"#,
            r#"always([+REQUEST_DECISION_LOG_REVIEW] true -> eventually(<+MEASURE_DECISION_LOG> true))"#,
            r#"always([+MEASURE_DECISION_LOG] true -> eventually(<+APPROVE_DECISION_LOG> true))"#,
            r#"always([+APPROVE_DECISION_LOG] true -> eventually(<+PUBLISH_DECISION_LOG> true))"#,
            ...
            r#"always([+REQUEST_DECISION_TIMELINE_REVIEW] true -> eventually(<+MEASURE_DECISION_TIMELINE> true))"#,
            r#"always([+MEASURE_DECISION_TIMELINE] true -> eventually(<+APPROVE_DECISION_TIMELINE> true))"#,
            r#"always([+APPROVE_DECISION_TIMELINE] true -> eventually(<+PUBLISH_DECISION_TIMELINE> true))"#,
            r#"always([+REQUEST_DECISION_DOCKET_REVIEW] true -> eventually(<+MEASURE_DECISION_DOCKET> true))"#,
            r#"always([+MEASURE_DECISION_DOCKET] true -> eventually(<+APPROVE_DECISION_DOCKET> true))"#,
            r#"always([+APPROVE_DECISION_DOCKET] true -> eventually(<+PUBLISH_DECISION_DOCKET> true))"#,
            r#"always([+REQUEST_DECISION_AGENDA_REVIEW] true -> eventually(<+MEASURE_DECISION_AGENDA> true))"#,
            r#"always([+MEASURE_DECISION_AGENDA] true -> eventually(<+APPROVE_DECISION_AGENDA> true))"#,
            r#"always([+APPROVE_DECISION_AGENDA] true -> eventually(<+PUBLISH_DECISION_AGENDA> true))"#,
            r#"always([+REQUEST_DECISION_SCHEDULE_REVIEW] true -> eventually(<+MEASURE_DECISION_SCHEDULE> true))"#,
            r#"always([+MEASURE_DECISION_SCHEDULE] true -> eventually(<+APPROVE_DECISION_SCHEDULE> true))"#,
            r#"always([+APPROVE_DECISION_SCHEDULE] true -> eventually(<+PUBLISH_DECISION_SCHEDULE> true))"#,
            r#"always([+REQUEST_DECISION_CALENDAR_REVIEW] true -> eventually(<+MEASURE_DECISION_CALENDAR> true))"#,
            r#"always([+MEASURE_DECISION_CALENDAR] true -> eventually(<+APPROVE_DECISION_CALENDAR> true))"#,
            r#"always([+APPROVE_DECISION_CALENDAR] true -> eventually(<+PUBLISH_DECISION_CALENDAR> true))"#,
            r#"always([+REQUEST_DECISION_TIMETABLE_REVIEW] true -> eventually(<+MEASURE_DECISION_TIMETABLE> true))"#,
            r#"always([+MEASURE_DECISION_TIMETABLE] true -> eventually(<+APPROVE_DECISION_TIMETABLE> true))"#,
            r#"always([+APPROVE_DECISION_TIMETABLE] true -> eventually(<+PUBLISH_DECISION_TIMETABLE> true))"#,
            r#"always([+REQUEST_DECISION_ROADMAP_REVIEW] true -> eventually(<+MEASURE_DECISION_ROADMAP> true))"#,
            r#"always([+MEASURE_DECISION_ROADMAP] true -> eventually(<+APPROVE_DECISION_ROADMAP> true))"#,
            r#"always([+APPROVE_DECISION_ROADMAP] true -> eventually(<+PUBLISH_DECISION_ROADMAP> true))"#,
            ...
            r#"always([+REQUEST_DECISION_TACTIC_REVIEW] true -> eventually(<+MEASURE_DECISION_TACTIC> true))"#,
            r#"always([+MEASURE_DECISION_TACTIC] true -> eventually(<+APPROVE_DECISION_TACTIC> true))"#,
            r#"always([+APPROVE_DECISION_TACTIC] true -> eventually(<+PUBLISH_DECISION_TACTIC> true))"#,
            r#"always([+REQUEST_DECISION_OPERATION_REVIEW] true -> eventually(<+MEASURE_DECISION_OPERATION> true))"#,
            r#"always([+MEASURE_DECISION_OPERATION] true -> eventually(<+APPROVE_DECISION_OPERATION> true))"#,
            r#"always([+APPROVE_DECISION_OPERATION] true -> eventually(<+PUBLISH_DECISION_OPERATION> true))"#,
            ...
            r#"always([+REQUEST_DECISION_DEPLOYMENT_REVIEW] true -> eventually(<+MEASURE_DECISION_DEPLOYMENT> true))"#,
            r#"always([+MEASURE_DECISION_DEPLOYMENT] true -> eventually(<+APPROVE_DECISION_DEPLOYMENT> true))"#,
            r#"always([+APPROVE_DECISION_DEPLOYMENT] true -> eventually(<+PUBLISH_DECISION_DEPLOYMENT> true))"#,
            r#"always([+REQUEST_DECISION_ROLLOUT_REVIEW] true -> eventually(<+MEASURE_DECISION_ROLLOUT> true))"#,
            r#"always([+MEASURE_DECISION_ROLLOUT] true -> eventually(<+APPROVE_DECISION_ROLLOUT> true))"#,
            r#"always([+APPROVE_DECISION_ROLLOUT] true -> eventually(<+PUBLISH_DECISION_ROLLOUT> true))"#,
            ...
            r#"always([+REQUEST_DECISION_LAUNCH_REVIEW] true -> eventually(<+MEASURE_DECISION_LAUNCH> true))"#,
            r#"always([+MEASURE_DECISION_LAUNCH] true -> eventually(<+APPROVE_DECISION_LAUNCH> true))"#,
            r#"always([+APPROVE_DECISION_LAUNCH] true -> eventually(<+PUBLISH_DECISION_LAUNCH> true))"#,
            r#"always([+REQUEST_DECISION_GENERAL_AVAILABILITY_REVIEW] true -> eventually(<+MEASURE_DECISION_GENERAL_AVAILABILITY> true))"#,
            r#"always([+MEASURE_DECISION_GENERAL_AVAILABILITY] true -> eventually(<+APPROVE_DECISION_GENERAL_AVAILABILITY> true))"#,
            r#"always([+APPROVE_DECISION_GENERAL_AVAILABILITY] true -> eventually(<+PUBLISH_DECISION_GENERAL_AVAILABILITY> true))"#,
            r#"always([+REQUEST_DECISION_PRODUCTION_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PRODUCTION_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_PRODUCTION_READINESS] true -> eventually(<+APPROVE_DECISION_PRODUCTION_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_PRODUCTION_READINESS] true -> eventually(<+PUBLISH_DECISION_PRODUCTION_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_OPERATIONAL_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_OPERATIONAL_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_OPERATIONAL_READINESS] true -> eventually(<+APPROVE_DECISION_OPERATIONAL_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_OPERATIONAL_READINESS] true -> eventually(<+PUBLISH_DECISION_OPERATIONAL_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_SERVICE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SERVICE_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_SERVICE_READINESS] true -> eventually(<+APPROVE_DECISION_SERVICE_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_SERVICE_READINESS] true -> eventually(<+PUBLISH_DECISION_SERVICE_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_SUPPORT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SUPPORT_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_SUPPORT_READINESS] true -> eventually(<+APPROVE_DECISION_SUPPORT_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_SUPPORT_READINESS] true -> eventually(<+PUBLISH_DECISION_SUPPORT_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_CUSTOMER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CUSTOMER_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_CUSTOMER_READINESS] true -> eventually(<+APPROVE_DECISION_CUSTOMER_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_CUSTOMER_READINESS] true -> eventually(<+PUBLISH_DECISION_CUSTOMER_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_STAKEHOLDER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_STAKEHOLDER_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_STAKEHOLDER_READINESS] true -> eventually(<+APPROVE_DECISION_STAKEHOLDER_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_STAKEHOLDER_READINESS] true -> eventually(<+PUBLISH_DECISION_STAKEHOLDER_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_PARTNER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PARTNER_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_PARTNER_READINESS] true -> eventually(<+APPROVE_DECISION_PARTNER_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_PARTNER_READINESS] true -> eventually(<+PUBLISH_DECISION_PARTNER_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_MARKET_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MARKET_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_MARKET_READINESS] true -> eventually(<+APPROVE_DECISION_MARKET_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_MARKET_READINESS] true -> eventually(<+PUBLISH_DECISION_MARKET_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_SALES_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SALES_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_SALES_READINESS] true -> eventually(<+APPROVE_DECISION_SALES_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_SALES_READINESS] true -> eventually(<+PUBLISH_DECISION_SALES_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_REVENUE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_REVENUE_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_REVENUE_READINESS] true -> eventually(<+APPROVE_DECISION_REVENUE_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_REVENUE_READINESS] true -> eventually(<+PUBLISH_DECISION_REVENUE_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_MARGIN_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MARGIN_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_MARGIN_READINESS] true -> eventually(<+APPROVE_DECISION_MARGIN_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_MARGIN_READINESS] true -> eventually(<+PUBLISH_DECISION_MARGIN_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_PROFIT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PROFIT_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_PROFIT_READINESS] true -> eventually(<+APPROVE_DECISION_PROFIT_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_PROFIT_READINESS] true -> eventually(<+PUBLISH_DECISION_PROFIT_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_COST_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_COST_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_COST_READINESS] true -> eventually(<+APPROVE_DECISION_COST_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_COST_READINESS] true -> eventually(<+PUBLISH_DECISION_COST_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_VALUE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_VALUE_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_VALUE_READINESS] true -> eventually(<+APPROVE_DECISION_VALUE_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_VALUE_READINESS] true -> eventually(<+PUBLISH_DECISION_VALUE_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_GROWTH_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_GROWTH_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_GROWTH_READINESS] true -> eventually(<+APPROVE_DECISION_GROWTH_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_GROWTH_READINESS] true -> eventually(<+PUBLISH_DECISION_GROWTH_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_PIPELINE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PIPELINE_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_PIPELINE_READINESS] true -> eventually(<+APPROVE_DECISION_PIPELINE_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_PIPELINE_READINESS] true -> eventually(<+PUBLISH_DECISION_PIPELINE_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_FORECAST_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_FORECAST_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_FORECAST_READINESS] true -> eventually(<+APPROVE_DECISION_FORECAST_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_FORECAST_READINESS] true -> eventually(<+PUBLISH_DECISION_FORECAST_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_DEMAND_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_DEMAND_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_DEMAND_READINESS] true -> eventually(<+APPROVE_DECISION_DEMAND_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_DEMAND_READINESS] true -> eventually(<+PUBLISH_DECISION_DEMAND_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_CAPACITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CAPACITY_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_CAPACITY_READINESS] true -> eventually(<+APPROVE_DECISION_CAPACITY_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_CAPACITY_READINESS] true -> eventually(<+PUBLISH_DECISION_CAPACITY_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_SUPPLY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SUPPLY_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_SUPPLY_READINESS] true -> eventually(<+APPROVE_DECISION_SUPPLY_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_SUPPLY_READINESS] true -> eventually(<+PUBLISH_DECISION_SUPPLY_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_LOGISTICS_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_LOGISTICS_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_LOGISTICS_READINESS] true -> eventually(<+APPROVE_DECISION_LOGISTICS_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_LOGISTICS_READINESS] true -> eventually(<+PUBLISH_DECISION_LOGISTICS_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_FULFILLMENT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_FULFILLMENT_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_FULFILLMENT_READINESS] true -> eventually(<+APPROVE_DECISION_FULFILLMENT_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_FULFILLMENT_READINESS] true -> eventually(<+PUBLISH_DECISION_FULFILLMENT_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_DELIVERY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_DELIVERY_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_DELIVERY_READINESS] true -> eventually(<+APPROVE_DECISION_DELIVERY_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_DELIVERY_READINESS] true -> eventually(<+PUBLISH_DECISION_DELIVERY_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_DISTRIBUTION_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_DISTRIBUTION_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_DISTRIBUTION_READINESS] true -> eventually(<+APPROVE_DECISION_DISTRIBUTION_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_DISTRIBUTION_READINESS] true -> eventually(<+PUBLISH_DECISION_DISTRIBUTION_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_CHANNEL_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CHANNEL_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_CHANNEL_READINESS] true -> eventually(<+APPROVE_DECISION_CHANNEL_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_CHANNEL_READINESS] true -> eventually(<+PUBLISH_DECISION_CHANNEL_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_SEGMENT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SEGMENT_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_SEGMENT_READINESS] true -> eventually(<+APPROVE_DECISION_SEGMENT_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_SEGMENT_READINESS] true -> eventually(<+PUBLISH_DECISION_SEGMENT_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_TERRITORY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_TERRITORY_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_TERRITORY_READINESS] true -> eventually(<+APPROVE_DECISION_TERRITORY_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_TERRITORY_READINESS] true -> eventually(<+PUBLISH_DECISION_TERRITORY_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_ACCOUNT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ACCOUNT_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_ACCOUNT_READINESS] true -> eventually(<+APPROVE_DECISION_ACCOUNT_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_ACCOUNT_READINESS] true -> eventually(<+PUBLISH_DECISION_ACCOUNT_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_OPPORTUNITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_OPPORTUNITY_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_OPPORTUNITY_READINESS] true -> eventually(<+APPROVE_DECISION_OPPORTUNITY_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_OPPORTUNITY_READINESS] true -> eventually(<+PUBLISH_DECISION_OPPORTUNITY_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_DEAL_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_DEAL_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_DEAL_READINESS] true -> eventually(<+APPROVE_DECISION_DEAL_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_DEAL_READINESS] true -> eventually(<+PUBLISH_DECISION_DEAL_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_QUOTE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_QUOTE_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_QUOTE_READINESS] true -> eventually(<+APPROVE_DECISION_QUOTE_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_QUOTE_READINESS] true -> eventually(<+PUBLISH_DECISION_QUOTE_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_CONTRACT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CONTRACT_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_CONTRACT_READINESS] true -> eventually(<+APPROVE_DECISION_CONTRACT_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_CONTRACT_READINESS] true -> eventually(<+PUBLISH_DECISION_CONTRACT_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_PROPOSAL_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PROPOSAL_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_PROPOSAL_READINESS] true -> eventually(<+APPROVE_DECISION_PROPOSAL_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_PROPOSAL_READINESS] true -> eventually(<+PUBLISH_DECISION_PROPOSAL_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_BID_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_BID_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_BID_READINESS] true -> eventually(<+APPROVE_DECISION_BID_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_BID_READINESS] true -> eventually(<+PUBLISH_DECISION_BID_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_TENDER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_TENDER_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_TENDER_READINESS] true -> eventually(<+APPROVE_DECISION_TENDER_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_TENDER_READINESS] true -> eventually(<+PUBLISH_DECISION_TENDER_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_PROCUREMENT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PROCUREMENT_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_PROCUREMENT_READINESS] true -> eventually(<+APPROVE_DECISION_PROCUREMENT_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_PROCUREMENT_READINESS] true -> eventually(<+PUBLISH_DECISION_PROCUREMENT_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_SOURCING_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SOURCING_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_SOURCING_READINESS] true -> eventually(<+APPROVE_DECISION_SOURCING_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_SOURCING_READINESS] true -> eventually(<+PUBLISH_DECISION_SOURCING_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_SUPPLIER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SUPPLIER_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_SUPPLIER_READINESS] true -> eventually(<+APPROVE_DECISION_SUPPLIER_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_SUPPLIER_READINESS] true -> eventually(<+PUBLISH_DECISION_SUPPLIER_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_VENDOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_VENDOR_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_VENDOR_READINESS] true -> eventually(<+APPROVE_DECISION_VENDOR_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_VENDOR_READINESS] true -> eventually(<+PUBLISH_DECISION_VENDOR_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_CONTRACTOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CONTRACTOR_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_CONTRACTOR_READINESS] true -> eventually(<+APPROVE_DECISION_CONTRACTOR_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_CONTRACTOR_READINESS] true -> eventually(<+PUBLISH_DECISION_CONTRACTOR_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_CONSULTANT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CONSULTANT_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_CONSULTANT_READINESS] true -> eventually(<+APPROVE_DECISION_CONSULTANT_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_CONSULTANT_READINESS] true -> eventually(<+PUBLISH_DECISION_CONSULTANT_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_ADVISOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ADVISOR_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_ADVISOR_READINESS] true -> eventually(<+APPROVE_DECISION_ADVISOR_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_ADVISOR_READINESS] true -> eventually(<+PUBLISH_DECISION_ADVISOR_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_EXPERT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_EXPERT_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_EXPERT_READINESS] true -> eventually(<+APPROVE_DECISION_EXPERT_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_EXPERT_READINESS] true -> eventually(<+PUBLISH_DECISION_EXPERT_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_SPECIALIST_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SPECIALIST_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_SPECIALIST_READINESS] true -> eventually(<+APPROVE_DECISION_SPECIALIST_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_SPECIALIST_READINESS] true -> eventually(<+PUBLISH_DECISION_SPECIALIST_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_PRACTITIONER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PRACTITIONER_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_PRACTITIONER_READINESS] true -> eventually(<+APPROVE_DECISION_PRACTITIONER_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_PRACTITIONER_READINESS] true -> eventually(<+PUBLISH_DECISION_PRACTITIONER_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_TECHNICIAN_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_TECHNICIAN_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_TECHNICIAN_READINESS] true -> eventually(<+APPROVE_DECISION_TECHNICIAN_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_TECHNICIAN_READINESS] true -> eventually(<+PUBLISH_DECISION_TECHNICIAN_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_ENGINEER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ENGINEER_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_ENGINEER_READINESS] true -> eventually(<+APPROVE_DECISION_ENGINEER_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_ENGINEER_READINESS] true -> eventually(<+PUBLISH_DECISION_ENGINEER_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_OPERATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_OPERATOR_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_OPERATOR_READINESS] true -> eventually(<+APPROVE_DECISION_OPERATOR_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_OPERATOR_READINESS] true -> eventually(<+PUBLISH_DECISION_OPERATOR_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_ANALYST_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ANALYST_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_ANALYST_READINESS] true -> eventually(<+APPROVE_DECISION_ANALYST_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_ANALYST_READINESS] true -> eventually(<+PUBLISH_DECISION_ANALYST_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_COORDINATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_COORDINATOR_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_COORDINATOR_READINESS] true -> eventually(<+APPROVE_DECISION_COORDINATOR_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_COORDINATOR_READINESS] true -> eventually(<+PUBLISH_DECISION_COORDINATOR_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_FACILITATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_FACILITATOR_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_FACILITATOR_READINESS] true -> eventually(<+APPROVE_DECISION_FACILITATOR_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_FACILITATOR_READINESS] true -> eventually(<+PUBLISH_DECISION_FACILITATOR_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_MEDIATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MEDIATOR_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_MEDIATOR_READINESS] true -> eventually(<+APPROVE_DECISION_MEDIATOR_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_MEDIATOR_READINESS] true -> eventually(<+PUBLISH_DECISION_MEDIATOR_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_ARBITRATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ARBITRATOR_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_ARBITRATOR_READINESS] true -> eventually(<+APPROVE_DECISION_ARBITRATOR_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_ARBITRATOR_READINESS] true -> eventually(<+PUBLISH_DECISION_ARBITRATOR_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_JUDGE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_JUDGE_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_JUDGE_READINESS] true -> eventually(<+APPROVE_DECISION_JUDGE_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_JUDGE_READINESS] true -> eventually(<+PUBLISH_DECISION_JUDGE_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_MAGISTRATE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MAGISTRATE_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_MAGISTRATE_READINESS] true -> eventually(<+APPROVE_DECISION_MAGISTRATE_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_MAGISTRATE_READINESS] true -> eventually(<+PUBLISH_DECISION_MAGISTRATE_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_ADJUDICATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ADJUDICATOR_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_ADJUDICATOR_READINESS] true -> eventually(<+APPROVE_DECISION_ADJUDICATOR_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_ADJUDICATOR_READINESS] true -> eventually(<+PUBLISH_DECISION_ADJUDICATOR_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_OMBUDSMAN_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_OMBUDSMAN_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_OMBUDSMAN_READINESS] true -> eventually(<+APPROVE_DECISION_OMBUDSMAN_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_OMBUDSMAN_READINESS] true -> eventually(<+PUBLISH_DECISION_OMBUDSMAN_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_REFEREE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_REFEREE_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_REFEREE_READINESS] true -> eventually(<+APPROVE_DECISION_REFEREE_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_REFEREE_READINESS] true -> eventually(<+PUBLISH_DECISION_REFEREE_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_UMPIRE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_UMPIRE_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_UMPIRE_READINESS] true -> eventually(<+APPROVE_DECISION_UMPIRE_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_UMPIRE_READINESS] true -> eventually(<+PUBLISH_DECISION_UMPIRE_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_MODERATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MODERATOR_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_MODERATOR_READINESS] true -> eventually(<+APPROVE_DECISION_MODERATOR_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_MODERATOR_READINESS] true -> eventually(<+PUBLISH_DECISION_MODERATOR_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_REVIEWER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_REVIEWER_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_REVIEWER_READINESS] true -> eventually(<+APPROVE_DECISION_REVIEWER_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_REVIEWER_READINESS] true -> eventually(<+PUBLISH_DECISION_REVIEWER_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_ASSESSOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ASSESSOR_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_ASSESSOR_READINESS] true -> eventually(<+APPROVE_DECISION_ASSESSOR_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_ASSESSOR_READINESS] true -> eventually(<+PUBLISH_DECISION_ASSESSOR_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_EVALUATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_EVALUATOR_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_EVALUATOR_READINESS] true -> eventually(<+APPROVE_DECISION_EVALUATOR_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_EVALUATOR_READINESS] true -> eventually(<+PUBLISH_DECISION_EVALUATOR_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_AUDITOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_AUDITOR_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_AUDITOR_READINESS] true -> eventually(<+APPROVE_DECISION_AUDITOR_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_AUDITOR_READINESS] true -> eventually(<+PUBLISH_DECISION_AUDITOR_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_INSPECTOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_INSPECTOR_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_INSPECTOR_READINESS] true -> eventually(<+APPROVE_DECISION_INSPECTOR_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_INSPECTOR_READINESS] true -> eventually(<+PUBLISH_DECISION_INSPECTOR_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_EXAMINER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_EXAMINER_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_EXAMINER_READINESS] true -> eventually(<+APPROVE_DECISION_EXAMINER_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_EXAMINER_READINESS] true -> eventually(<+PUBLISH_DECISION_EXAMINER_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_MONITOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MONITOR_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_MONITOR_READINESS] true -> eventually(<+APPROVE_DECISION_MONITOR_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_MONITOR_READINESS] true -> eventually(<+PUBLISH_DECISION_MONITOR_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_OBSERVER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_OBSERVER_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_OBSERVER_READINESS] true -> eventually(<+APPROVE_DECISION_OBSERVER_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_OBSERVER_READINESS] true -> eventually(<+PUBLISH_DECISION_OBSERVER_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_WATCHER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_WATCHER_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_WATCHER_READINESS] true -> eventually(<+APPROVE_DECISION_WATCHER_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_WATCHER_READINESS] true -> eventually(<+PUBLISH_DECISION_WATCHER_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_SENTINEL_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SENTINEL_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_SENTINEL_READINESS] true -> eventually(<+APPROVE_DECISION_SENTINEL_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_SENTINEL_READINESS] true -> eventually(<+PUBLISH_DECISION_SENTINEL_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_GUARDIAN_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_GUARDIAN_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_GUARDIAN_READINESS] true -> eventually(<+APPROVE_DECISION_GUARDIAN_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_GUARDIAN_READINESS] true -> eventually(<+PUBLISH_DECISION_GUARDIAN_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_CUSTODIAN_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CUSTODIAN_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_CUSTODIAN_READINESS] true -> eventually(<+APPROVE_DECISION_CUSTODIAN_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_CUSTODIAN_READINESS] true -> eventually(<+PUBLISH_DECISION_CUSTODIAN_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_STEWARD_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_STEWARD_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_STEWARD_READINESS] true -> eventually(<+APPROVE_DECISION_STEWARD_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_STEWARD_READINESS] true -> eventually(<+PUBLISH_DECISION_STEWARD_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_TRUSTEE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_TRUSTEE_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_TRUSTEE_READINESS] true -> eventually(<+APPROVE_DECISION_TRUSTEE_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_TRUSTEE_READINESS] true -> eventually(<+PUBLISH_DECISION_TRUSTEE_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_FIDUCIARY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_FIDUCIARY_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_FIDUCIARY_READINESS] true -> eventually(<+APPROVE_DECISION_FIDUCIARY_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_FIDUCIARY_READINESS] true -> eventually(<+PUBLISH_DECISION_FIDUCIARY_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_COMPLIANCE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_COMPLIANCE_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_COMPLIANCE_READINESS] true -> eventually(<+APPROVE_DECISION_COMPLIANCE_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_COMPLIANCE_READINESS] true -> eventually(<+PUBLISH_DECISION_COMPLIANCE_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_RISK_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_RISK_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_RISK_READINESS] true -> eventually(<+APPROVE_DECISION_RISK_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_RISK_READINESS] true -> eventually(<+PUBLISH_DECISION_RISK_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_SAFETY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SAFETY_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_SAFETY_READINESS] true -> eventually(<+APPROVE_DECISION_SAFETY_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_SAFETY_READINESS] true -> eventually(<+PUBLISH_DECISION_SAFETY_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_SECURITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SECURITY_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_SECURITY_READINESS] true -> eventually(<+APPROVE_DECISION_SECURITY_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_SECURITY_READINESS] true -> eventually(<+PUBLISH_DECISION_SECURITY_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_PRIVACY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PRIVACY_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_PRIVACY_READINESS] true -> eventually(<+APPROVE_DECISION_PRIVACY_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_PRIVACY_READINESS] true -> eventually(<+PUBLISH_DECISION_PRIVACY_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_DATA_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_DATA_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_DATA_READINESS] true -> eventually(<+APPROVE_DECISION_DATA_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_DATA_READINESS] true -> eventually(<+PUBLISH_DECISION_DATA_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_AI_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_AI_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_AI_READINESS] true -> eventually(<+APPROVE_DECISION_AI_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_AI_READINESS] true -> eventually(<+PUBLISH_DECISION_AI_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_ML_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ML_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_ML_READINESS] true -> eventually(<+APPROVE_DECISION_ML_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_ML_READINESS] true -> eventually(<+PUBLISH_DECISION_ML_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_MODEL_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MODEL_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_MODEL_READINESS] true -> eventually(<+APPROVE_DECISION_MODEL_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_MODEL_READINESS] true -> eventually(<+PUBLISH_DECISION_MODEL_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_ALGORITHM_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ALGORITHM_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_ALGORITHM_READINESS] true -> eventually(<+APPROVE_DECISION_ALGORITHM_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_ALGORITHM_READINESS] true -> eventually(<+PUBLISH_DECISION_ALGORITHM_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_AUTOMATION_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_AUTOMATION_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_AUTOMATION_READINESS] true -> eventually(<+APPROVE_DECISION_AUTOMATION_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_AUTOMATION_READINESS] true -> eventually(<+PUBLISH_DECISION_AUTOMATION_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_ORCHESTRATION_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ORCHESTRATION_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_ORCHESTRATION_READINESS] true -> eventually(<+APPROVE_DECISION_ORCHESTRATION_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_ORCHESTRATION_READINESS] true -> eventually(<+PUBLISH_DECISION_ORCHESTRATION_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_COORDINATION_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_COORDINATION_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_COORDINATION_READINESS] true -> eventually(<+APPROVE_DECISION_COORDINATION_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_COORDINATION_READINESS] true -> eventually(<+PUBLISH_DECISION_COORDINATION_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_COLLABORATION_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_COLLABORATION_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_COLLABORATION_READINESS] true -> eventually(<+APPROVE_DECISION_COLLABORATION_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_COLLABORATION_READINESS] true -> eventually(<+PUBLISH_DECISION_COLLABORATION_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_INTEGRATION_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_INTEGRATION_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_INTEGRATION_READINESS] true -> eventually(<+APPROVE_DECISION_INTEGRATION_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_INTEGRATION_READINESS] true -> eventually(<+PUBLISH_DECISION_INTEGRATION_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_INTEROPERABILITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_INTEROPERABILITY_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_INTEROPERABILITY_READINESS] true -> eventually(<+APPROVE_DECISION_INTEROPERABILITY_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_INTEROPERABILITY_READINESS] true -> eventually(<+PUBLISH_DECISION_INTEROPERABILITY_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_COMPATIBILITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_COMPATIBILITY_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_COMPATIBILITY_READINESS] true -> eventually(<+APPROVE_DECISION_COMPATIBILITY_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_COMPATIBILITY_READINESS] true -> eventually(<+PUBLISH_DECISION_COMPATIBILITY_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_PORTABILITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PORTABILITY_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_PORTABILITY_READINESS] true -> eventually(<+APPROVE_DECISION_PORTABILITY_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_PORTABILITY_READINESS] true -> eventually(<+PUBLISH_DECISION_PORTABILITY_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_TRANSFERABILITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_TRANSFERABILITY_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_TRANSFERABILITY_READINESS] true -> eventually(<+APPROVE_DECISION_TRANSFERABILITY_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_TRANSFERABILITY_READINESS] true -> eventually(<+PUBLISH_DECISION_TRANSFERABILITY_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_ASSIGNABILITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ASSIGNABILITY_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_ASSIGNABILITY_READINESS] true -> eventually(<+APPROVE_DECISION_ASSIGNABILITY_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_ASSIGNABILITY_READINESS] true -> eventually(<+PUBLISH_DECISION_ASSIGNABILITY_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_MOBILITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MOBILITY_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_MOBILITY_READINESS] true -> eventually(<+APPROVE_DECISION_MOBILITY_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_MOBILITY_READINESS] true -> eventually(<+PUBLISH_DECISION_MOBILITY_READINESS> true))"#,
            r#"always([+REQUEST_DECISION_SCALABILITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SCALABILITY_READINESS> true))"#,
            r#"always([+MEASURE_DECISION_SCALABILITY_READINESS] true -> eventually(<+APPROVE_DECISION_SCALABILITY_READINESS> true))"#,
            r#"always([+APPROVE_DECISION_SCALABILITY_READINESS] true -> eventually(<+PUBLISH_DECISION_SCALABILITY_READINESS> true))"#,
...
"#;
    ...
    #[test]
    fn synthesis_list_includes_agent_benchmark_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_AGENT_BENCHMARK_CHANGE] true -> eventually(<+RUN_AGENT_BENCHMARK> true))"
        ));
        assert!(output.contains(
            "always([+RUN_AGENT_BENCHMARK] true -> eventually(<+APPROVE_AGENT_BENCHMARK_CHANGE> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_agent_eval_dataset_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_AGENT_EVAL_DATASET_CHANGE] true -> eventually(<+REVIEW_AGENT_EVAL_DATASET> true))"
        ));
        assert!(output.contains(
            "always([+REVIEW_AGENT_EVAL_DATASET] true -> eventually(<+APPROVE_AGENT_EVAL_DATASET_CHANGE> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_agent_alert_rule_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_AGENT_ALERT_RULE_CHANGE] true -> eventually(<+REVIEW_AGENT_ALERT_RULE> true))"
        ));
        assert!(output.contains(
            "always([+REVIEW_AGENT_ALERT_RULE] true -> eventually(<+APPROVE_AGENT_ALERT_RULE_CHANGE> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_agent_escalation_policy_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_AGENT_ESCALATION_POLICY_CHANGE] true -> eventually(<+REVIEW_AGENT_ESCALATION_POLICY> true))"
        ));
        assert!(output.contains(
            "always([+REVIEW_AGENT_ESCALATION_POLICY] true -> eventually(<+APPROVE_AGENT_ESCALATION_POLICY_CHANGE> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_AGENT_ESCALATION_POLICY_CHANGE] true -> eventually(<+APPLY_AGENT_ESCALATION_POLICY> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_agent_notification_policy_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_AGENT_NOTIFICATION_POLICY_CHANGE] true -> eventually(<+REVIEW_AGENT_NOTIFICATION_POLICY> true))"
        ));
        assert!(output.contains(
            "always([+REVIEW_AGENT_NOTIFICATION_POLICY] true -> eventually(<+APPROVE_AGENT_NOTIFICATION_POLICY_CHANGE> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_AGENT_NOTIFICATION_POLICY_CHANGE] true -> eventually(<+APPLY_AGENT_NOTIFICATION_POLICY> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_agent_heartbeat_policy_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_AGENT_HEARTBEAT_POLICY_CHANGE] true -> eventually(<+REVIEW_AGENT_HEARTBEAT_POLICY> true))"
        ));
        assert!(output.contains(
            "always([+REVIEW_AGENT_HEARTBEAT_POLICY] true -> eventually(<+APPROVE_AGENT_HEARTBEAT_POLICY_CHANGE> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_AGENT_HEARTBEAT_POLICY_CHANGE] true -> eventually(<+APPLY_AGENT_HEARTBEAT_POLICY> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_agent_quiet_hours_policy_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_AGENT_QUIET_HOURS_POLICY_CHANGE] true -> eventually(<+REVIEW_AGENT_QUIET_HOURS_POLICY> true))"
        ));
        assert!(output.contains(
            "always([+REVIEW_AGENT_QUIET_HOURS_POLICY] true -> eventually(<+APPROVE_AGENT_QUIET_HOURS_POLICY_CHANGE> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_agent_reminder_policy_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_AGENT_REMINDER_POLICY_CHANGE] true -> eventually(<+REVIEW_AGENT_REMINDER_POLICY> true))"
        ));
        assert!(output.contains(
            "always([+REVIEW_AGENT_REMINDER_POLICY] true -> eventually(<+APPROVE_AGENT_REMINDER_POLICY_CHANGE> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_AGENT_REMINDER_POLICY_CHANGE] true -> eventually(<+APPLY_AGENT_REMINDER_POLICY> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_agent_digest_policy_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_AGENT_DIGEST_POLICY_CHANGE] true -> eventually(<+REVIEW_AGENT_DIGEST_POLICY> true))"
        ));
        assert!(output.contains(
            "always([+REVIEW_AGENT_DIGEST_POLICY] true -> eventually(<+APPROVE_AGENT_DIGEST_POLICY_CHANGE> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_retention_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_RETENTION_REVIEW] true -> eventually(<+CLASSIFY_DECISION_RECORDS> true))"
        ));
        assert!(output.contains(
            "always([+CLASSIFY_DECISION_RECORDS] true -> eventually(<+APPROVE_DECISION_RETENTION> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_disclosure_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_DISCLOSURE] true -> eventually(<+REVIEW_DECISION_DISCLOSURE_SCOPE> true))"
        ));
        assert!(output.contains(
            "always([+REVIEW_DECISION_DISCLOSURE_SCOPE] true -> eventually(<+APPROVE_DECISION_DISCLOSURE> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_DISCLOSURE] true -> eventually(<+DELIVER_DECISION_DISCLOSURE> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_portability_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_PORTABILITY] true -> eventually(<+VERIFY_DECISION_PORTABILITY_SCOPE> true))"
        ));
        assert!(output.contains(
            "always([+VERIFY_DECISION_PORTABILITY_SCOPE] true -> eventually(<+APPROVE_DECISION_PORTABILITY> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_PORTABILITY] true -> eventually(<+DELIVER_DECISION_PORTABILITY_PACKAGE> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_provenance_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_PROVENANCE] true -> eventually(<+TRACE_DECISION_INPUTS> true))"
        ));
        assert!(output.contains(
            "always([+TRACE_DECISION_INPUTS] true -> eventually(<+APPROVE_DECISION_PROVENANCE> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_transparency_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_TRANSPARENCY_REVIEW] true -> eventually(<+COLLECT_DECISION_TRANSPARENCY_EVIDENCE> true))"
        ));
        assert!(output.contains(
            "always([+COLLECT_DECISION_TRANSPARENCY_EVIDENCE] true -> eventually(<+APPROVE_DECISION_TRANSPARENCY> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_TRANSPARENCY] true -> eventually(<+PUBLISH_DECISION_TRANSPARENCY_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_rationale_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_RATIONALE] true -> eventually(<+ASSEMBLE_DECISION_RATIONALE> true))"
        ));
        assert!(output.contains(
            "always([+ASSEMBLE_DECISION_RATIONALE] true -> eventually(<+APPROVE_DECISION_RATIONALE> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_threshold_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_THRESHOLD_REVIEW] true -> eventually(<+ANALYZE_DECISION_THRESHOLDS> true))"
        ));
        assert!(output.contains(
            "always([+ANALYZE_DECISION_THRESHOLDS] true -> eventually(<+APPROVE_DECISION_THRESHOLD_UPDATE> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_THRESHOLD_UPDATE] true -> eventually(<+RECORD_DECISION_THRESHOLD> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_policy_exception_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_POLICY_EXCEPTION] true -> eventually(<+ASSESS_DECISION_POLICY_RISK> true))"
        ));
        assert!(output.contains(
            "always([+ASSESS_DECISION_POLICY_RISK] true -> eventually(<+APPROVE_DECISION_POLICY_EXCEPTION> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_reliability_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_RELIABILITY_REVIEW] true -> eventually(<+MEASURE_DECISION_RELIABILITY> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_RELIABILITY] true -> eventually(<+APPROVE_DECISION_RELIABILITY_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_RELIABILITY_REPORT] true -> eventually(<+PUBLISH_DECISION_RELIABILITY_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_robustness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_ROBUSTNESS_REVIEW] true -> eventually(<+TEST_DECISION_ROBUSTNESS> true))"
        ));
        assert!(output.contains(
            "always([+TEST_DECISION_ROBUSTNESS] true -> eventually(<+APPROVE_DECISION_ROBUSTNESS_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_ROBUSTNESS_REPORT] true -> eventually(<+PUBLISH_DECISION_ROBUSTNESS_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_consistency_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_CONSISTENCY_REVIEW] true -> eventually(<+COMPARE_DECISION_CONSISTENCY> true))"
        ));
        assert!(output.contains(
            "always([+COMPARE_DECISION_CONSISTENCY] true -> eventually(<+APPROVE_DECISION_CONSISTENCY_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_CONSISTENCY_REPORT] true -> eventually(<+PUBLISH_DECISION_CONSISTENCY_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_accuracy_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_ACCURACY_REVIEW] true -> eventually(<+MEASURE_DECISION_ACCURACY> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_ACCURACY] true -> eventually(<+APPROVE_DECISION_ACCURACY_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_ACCURACY_REPORT] true -> eventually(<+PUBLISH_DECISION_ACCURACY_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_precision_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_PRECISION_REVIEW] true -> eventually(<+MEASURE_DECISION_PRECISION> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_PRECISION] true -> eventually(<+APPROVE_DECISION_PRECISION_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_PRECISION_REPORT] true -> eventually(<+PUBLISH_DECISION_PRECISION_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_recall_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_RECALL_REVIEW] true -> eventually(<+MEASURE_DECISION_RECALL> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_RECALL] true -> eventually(<+APPROVE_DECISION_RECALL_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_RECALL_REPORT] true -> eventually(<+PUBLISH_DECISION_RECALL_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_specificity_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SPECIFICITY_REVIEW] true -> eventually(<+MEASURE_DECISION_SPECIFICITY> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SPECIFICITY] true -> eventually(<+APPROVE_DECISION_SPECIFICITY_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SPECIFICITY_REPORT] true -> eventually(<+PUBLISH_DECISION_SPECIFICITY_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_sensitivity_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SENSITIVITY_REVIEW] true -> eventually(<+MEASURE_DECISION_SENSITIVITY> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SENSITIVITY] true -> eventually(<+APPROVE_DECISION_SENSITIVITY_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SENSITIVITY_REPORT] true -> eventually(<+PUBLISH_DECISION_SENSITIVITY_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_selectivity_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SELECTIVITY_REVIEW] true -> eventually(<+MEASURE_DECISION_SELECTIVITY> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SELECTIVITY] true -> eventually(<+APPROVE_DECISION_SELECTIVITY_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SELECTIVITY_REPORT] true -> eventually(<+PUBLISH_DECISION_SELECTIVITY_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_prevalence_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_PREVALENCE_REVIEW] true -> eventually(<+MEASURE_DECISION_PREVALENCE> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_PREVALENCE] true -> eventually(<+APPROVE_DECISION_PREVALENCE_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_PREVALENCE_REPORT] true -> eventually(<+PUBLISH_DECISION_PREVALENCE_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_incidence_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_INCIDENCE_REVIEW] true -> eventually(<+MEASURE_DECISION_INCIDENCE> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_INCIDENCE] true -> eventually(<+APPROVE_DECISION_INCIDENCE_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_INCIDENCE_REPORT] true -> eventually(<+PUBLISH_DECISION_INCIDENCE_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_lift_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_LIFT_REVIEW] true -> eventually(<+MEASURE_DECISION_LIFT> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_LIFT] true -> eventually(<+APPROVE_DECISION_LIFT_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_LIFT_REPORT] true -> eventually(<+PUBLISH_DECISION_LIFT_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_gain_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_GAIN_REVIEW] true -> eventually(<+MEASURE_DECISION_GAIN> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_GAIN] true -> eventually(<+APPROVE_DECISION_GAIN_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_GAIN_REPORT] true -> eventually(<+PUBLISH_DECISION_GAIN_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_odds_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_ODDS_REVIEW] true -> eventually(<+MEASURE_DECISION_ODDS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_ODDS] true -> eventually(<+APPROVE_DECISION_ODDS_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_ODDS_REPORT] true -> eventually(<+PUBLISH_DECISION_ODDS_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_risk_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_RISK_REVIEW] true -> eventually(<+MEASURE_DECISION_RISK> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_RISK] true -> eventually(<+APPROVE_DECISION_RISK_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_RISK_REPORT] true -> eventually(<+PUBLISH_DECISION_RISK_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_exposure_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_EXPOSURE_REVIEW] true -> eventually(<+MEASURE_DECISION_EXPOSURE> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_EXPOSURE] true -> eventually(<+APPROVE_DECISION_EXPOSURE_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_EXPOSURE_REPORT] true -> eventually(<+PUBLISH_DECISION_EXPOSURE_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_harm_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_HARM_REVIEW] true -> eventually(<+MEASURE_DECISION_HARM> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_HARM] true -> eventually(<+APPROVE_DECISION_HARM_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_HARM_REPORT] true -> eventually(<+PUBLISH_DECISION_HARM_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_loss_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_LOSS_REVIEW] true -> eventually(<+MEASURE_DECISION_LOSS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_LOSS] true -> eventually(<+APPROVE_DECISION_LOSS_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_LOSS_REPORT] true -> eventually(<+PUBLISH_DECISION_LOSS_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_severity_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SEVERITY_REVIEW] true -> eventually(<+MEASURE_DECISION_SEVERITY> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SEVERITY] true -> eventually(<+APPROVE_DECISION_SEVERITY_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SEVERITY_REPORT] true -> eventually(<+PUBLISH_DECISION_SEVERITY_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_cost_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_COST_REVIEW] true -> eventually(<+MEASURE_DECISION_COST> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_COST] true -> eventually(<+APPROVE_DECISION_COST_REPORT> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_value_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_VALUE_REVIEW] true -> eventually(<+MEASURE_DECISION_VALUE> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_VALUE] true -> eventually(<+APPROVE_DECISION_VALUE_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_VALUE_REPORT] true -> eventually(<+PUBLISH_DECISION_VALUE_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_utility_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_UTILITY_REVIEW] true -> eventually(<+MEASURE_DECISION_UTILITY> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_UTILITY] true -> eventually(<+APPROVE_DECISION_UTILITY_REPORT> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_rank_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_RANK_REVIEW] true -> eventually(<+MEASURE_DECISION_RANK> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_RANK] true -> eventually(<+APPROVE_DECISION_RANK_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_RANK_REPORT] true -> eventually(<+PUBLISH_DECISION_RANK_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_score_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SCORE_REVIEW] true -> eventually(<+MEASURE_DECISION_SCORE> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SCORE] true -> eventually(<+APPROVE_DECISION_SCORE_REPORT> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_influence_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_INFLUENCE_REVIEW] true -> eventually(<+MEASURE_DECISION_INFLUENCE> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_INFLUENCE] true -> eventually(<+APPROVE_DECISION_INFLUENCE_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_INFLUENCE_REPORT] true -> eventually(<+PUBLISH_DECISION_INFLUENCE_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_contribution_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_CONTRIBUTION_REVIEW] true -> eventually(<+MEASURE_DECISION_CONTRIBUTION> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_CONTRIBUTION] true -> eventually(<+APPROVE_DECISION_CONTRIBUTION_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_CONTRIBUTION_REPORT] true -> eventually(<+PUBLISH_DECISION_CONTRIBUTION_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_importance_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_IMPORTANCE_REVIEW] true -> eventually(<+MEASURE_DECISION_IMPORTANCE> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_IMPORTANCE] true -> eventually(<+APPROVE_DECISION_IMPORTANCE_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_IMPORTANCE_REPORT] true -> eventually(<+PUBLISH_DECISION_IMPORTANCE_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_salience_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SALIENCE_REVIEW] true -> eventually(<+MEASURE_DECISION_SALIENCE> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SALIENCE] true -> eventually(<+APPROVE_DECISION_SALIENCE_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SALIENCE_REPORT] true -> eventually(<+PUBLISH_DECISION_SALIENCE_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_relevance_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_RELEVANCE_REVIEW] true -> eventually(<+MEASURE_DECISION_RELEVANCE> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_RELEVANCE] true -> eventually(<+APPROVE_DECISION_RELEVANCE_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_RELEVANCE_REPORT] true -> eventually(<+PUBLISH_DECISION_RELEVANCE_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_pertinence_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_PERTINENCE_REVIEW] true -> eventually(<+MEASURE_DECISION_PERTINENCE> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_PERTINENCE] true -> eventually(<+APPROVE_DECISION_PERTINENCE_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_PERTINENCE_REPORT] true -> eventually(<+PUBLISH_DECISION_PERTINENCE_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_applicability_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_APPLICABILITY_REVIEW] true -> eventually(<+MEASURE_DECISION_APPLICABILITY> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_APPLICABILITY] true -> eventually(<+APPROVE_DECISION_APPLICABILITY_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_APPLICABILITY_REPORT] true -> eventually(<+PUBLISH_DECISION_APPLICABILITY_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_suitability_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SUITABILITY_REVIEW] true -> eventually(<+MEASURE_DECISION_SUITABILITY> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SUITABILITY] true -> eventually(<+APPROVE_DECISION_SUITABILITY_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SUITABILITY_REPORT] true -> eventually(<+PUBLISH_DECISION_SUITABILITY_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_appropriateness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_APPROPRIATENESS_REVIEW] true -> eventually(<+MEASURE_DECISION_APPROPRIATENESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_APPROPRIATENESS] true -> eventually(<+APPROVE_DECISION_APPROPRIATENESS_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_APPROPRIATENESS_REPORT] true -> eventually(<+PUBLISH_DECISION_APPROPRIATENESS_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_adequacy_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_ADEQUACY_REVIEW] true -> eventually(<+MEASURE_DECISION_ADEQUACY> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_ADEQUACY] true -> eventually(<+APPROVE_DECISION_ADEQUACY_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_ADEQUACY_REPORT] true -> eventually(<+PUBLISH_DECISION_ADEQUACY_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_sufficiency_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SUFFICIENCY_REVIEW] true -> eventually(<+MEASURE_DECISION_SUFFICIENCY> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SUFFICIENCY] true -> eventually(<+APPROVE_DECISION_SUFFICIENCY_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SUFFICIENCY_REPORT] true -> eventually(<+PUBLISH_DECISION_SUFFICIENCY_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_completeness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_COMPLETENESS_REVIEW] true -> eventually(<+MEASURE_DECISION_COMPLETENESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_COMPLETENESS] true -> eventually(<+APPROVE_DECISION_COMPLETENESS_REPORT> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_scope_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SCOPE_REVIEW] true -> eventually(<+MEASURE_DECISION_SCOPE> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SCOPE] true -> eventually(<+APPROVE_DECISION_SCOPE_REPORT> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_range_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_RANGE_REVIEW] true -> eventually(<+MEASURE_DECISION_RANGE> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_RANGE] true -> eventually(<+APPROVE_DECISION_RANGE_REPORT> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_bounds_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_BOUNDS_REVIEW] true -> eventually(<+MEASURE_DECISION_BOUNDS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_BOUNDS] true -> eventually(<+APPROVE_DECISION_BOUNDS_REPORT> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_boundaries_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_BOUNDARIES_REVIEW] true -> eventually(<+MEASURE_DECISION_BOUNDARIES> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_BOUNDARIES] true -> eventually(<+APPROVE_DECISION_BOUNDARIES_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_BOUNDARIES_REPORT] true -> eventually(<+PUBLISH_DECISION_BOUNDARIES_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_criteria_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_CRITERIA_REVIEW] true -> eventually(<+MEASURE_DECISION_CRITERIA> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_CRITERIA] true -> eventually(<+APPROVE_DECISION_CRITERIA_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_CRITERIA_REPORT] true -> eventually(<+PUBLISH_DECISION_CRITERIA_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_conditions_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_CONDITIONS_REVIEW] true -> eventually(<+MEASURE_DECISION_CONDITIONS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_CONDITIONS] true -> eventually(<+APPROVE_DECISION_CONDITIONS_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_CONDITIONS_REPORT] true -> eventually(<+PUBLISH_DECISION_CONDITIONS_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_limits_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_LIMITS_REVIEW] true -> eventually(<+MEASURE_DECISION_LIMITS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_LIMITS] true -> eventually(<+APPROVE_DECISION_LIMITS_REPORT> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_constraints_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_CONSTRAINTS_REVIEW] true -> eventually(<+MEASURE_DECISION_CONSTRAINTS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_CONSTRAINTS] true -> eventually(<+APPROVE_DECISION_CONSTRAINTS_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_CONSTRAINTS_REPORT] true -> eventually(<+PUBLISH_DECISION_CONSTRAINTS_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_restrictions_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_RESTRICTIONS_REVIEW] true -> eventually(<+MEASURE_DECISION_RESTRICTIONS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_RESTRICTIONS] true -> eventually(<+APPROVE_DECISION_RESTRICTIONS_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_RESTRICTIONS_REPORT] true -> eventually(<+PUBLISH_DECISION_RESTRICTIONS_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_requirements_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_REQUIREMENTS_REVIEW] true -> eventually(<+MEASURE_DECISION_REQUIREMENTS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_REQUIREMENTS] true -> eventually(<+APPROVE_DECISION_REQUIREMENTS_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_REQUIREMENTS_REPORT] true -> eventually(<+PUBLISH_DECISION_REQUIREMENTS_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_specifications_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SPECIFICATIONS_REVIEW] true -> eventually(<+MEASURE_DECISION_SPECIFICATIONS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SPECIFICATIONS] true -> eventually(<+APPROVE_DECISION_SPECIFICATIONS_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SPECIFICATIONS_REPORT] true -> eventually(<+PUBLISH_DECISION_SPECIFICATIONS_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_parameters_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_PARAMETERS_REVIEW] true -> eventually(<+MEASURE_DECISION_PARAMETERS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_PARAMETERS] true -> eventually(<+APPROVE_DECISION_PARAMETERS_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_PARAMETERS_REPORT] true -> eventually(<+PUBLISH_DECISION_PARAMETERS_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_settings_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SETTINGS_REVIEW] true -> eventually(<+MEASURE_DECISION_SETTINGS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SETTINGS] true -> eventually(<+APPROVE_DECISION_SETTINGS_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SETTINGS_REPORT] true -> eventually(<+PUBLISH_DECISION_SETTINGS_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_configuration_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_CONFIGURATION_REVIEW] true -> eventually(<+MEASURE_DECISION_CONFIGURATION> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_CONFIGURATION] true -> eventually(<+APPROVE_DECISION_CONFIGURATION_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_CONFIGURATION_REPORT] true -> eventually(<+PUBLISH_DECISION_CONFIGURATION_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_preference_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_PREFERENCE_REVIEW] true -> eventually(<+MEASURE_DECISION_PREFERENCE> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_PREFERENCE] true -> eventually(<+APPROVE_DECISION_PREFERENCE_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_PREFERENCE_REPORT] true -> eventually(<+PUBLISH_DECISION_PREFERENCE_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_option_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_OPTION_REVIEW] true -> eventually(<+MEASURE_DECISION_OPTION> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_OPTION] true -> eventually(<+APPROVE_DECISION_OPTION_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_OPTION_REPORT] true -> eventually(<+PUBLISH_DECISION_OPTION_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_alternative_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_ALTERNATIVE_REVIEW] true -> eventually(<+MEASURE_DECISION_ALTERNATIVE> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_ALTERNATIVE] true -> eventually(<+APPROVE_DECISION_ALTERNATIVE_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_ALTERNATIVE_REPORT] true -> eventually(<+PUBLISH_DECISION_ALTERNATIVE_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_choice_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_CHOICE_REVIEW] true -> eventually(<+MEASURE_DECISION_CHOICE> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_CHOICE] true -> eventually(<+APPROVE_DECISION_CHOICE_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_CHOICE_REPORT] true -> eventually(<+PUBLISH_DECISION_CHOICE_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_selection_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SELECTION_REVIEW] true -> eventually(<+MEASURE_DECISION_SELECTION> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SELECTION] true -> eventually(<+APPROVE_DECISION_SELECTION_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SELECTION_REPORT] true -> eventually(<+PUBLISH_DECISION_SELECTION_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_recommendation_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_RECOMMENDATION_REVIEW] true -> eventually(<+MEASURE_DECISION_RECOMMENDATION> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_RECOMMENDATION] true -> eventually(<+APPROVE_DECISION_RECOMMENDATION_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_RECOMMENDATION_REPORT] true -> eventually(<+PUBLISH_DECISION_RECOMMENDATION_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_proposal_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_PROPOSAL_REVIEW] true -> eventually(<+MEASURE_DECISION_PROPOSAL> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_PROPOSAL] true -> eventually(<+APPROVE_DECISION_PROPOSAL_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_PROPOSAL_REPORT] true -> eventually(<+PUBLISH_DECISION_PROPOSAL_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_submission_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SUBMISSION_REVIEW] true -> eventually(<+MEASURE_DECISION_SUBMISSION> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SUBMISSION] true -> eventually(<+APPROVE_DECISION_SUBMISSION_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SUBMISSION_REPORT] true -> eventually(<+PUBLISH_DECISION_SUBMISSION_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_document_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_DOCUMENT_REVIEW] true -> eventually(<+MEASURE_DECISION_DOCUMENT> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_DOCUMENT] true -> eventually(<+APPROVE_DECISION_DOCUMENT_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_DOCUMENT_REPORT] true -> eventually(<+PUBLISH_DECISION_DOCUMENT_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_report_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_REPORT_REVIEW] true -> eventually(<+MEASURE_DECISION_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_REPORT] true -> eventually(<+APPROVE_DECISION_REPORT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_REPORT] true -> eventually(<+PUBLISH_DECISION_REPORT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_memo_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_MEMO_REVIEW] true -> eventually(<+MEASURE_DECISION_MEMO> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_MEMO] true -> eventually(<+APPROVE_DECISION_MEMO> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_minutes_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_MINUTES_REVIEW] true -> eventually(<+MEASURE_DECISION_MINUTES> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_MINUTES] true -> eventually(<+APPROVE_DECISION_MINUTES> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_MINUTES] true -> eventually(<+PUBLISH_DECISION_MINUTES> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_transcript_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_TRANSCRIPT_REVIEW] true -> eventually(<+MEASURE_DECISION_TRANSCRIPT> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_TRANSCRIPT] true -> eventually(<+APPROVE_DECISION_TRANSCRIPT> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_TRANSCRIPT] true -> eventually(<+PUBLISH_DECISION_TRANSCRIPT> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_recording_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_RECORDING_REVIEW] true -> eventually(<+MEASURE_DECISION_RECORDING> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_RECORDING] true -> eventually(<+APPROVE_DECISION_RECORDING> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_catalog_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_CATALOG_REVIEW] true -> eventually(<+MEASURE_DECISION_CATALOG> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_CATALOG] true -> eventually(<+APPROVE_DECISION_CATALOG> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_CATALOG] true -> eventually(<+PUBLISH_DECISION_CATALOG> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_inventory_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_INVENTORY_REVIEW] true -> eventually(<+MEASURE_DECISION_INVENTORY> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_INVENTORY] true -> eventually(<+APPROVE_DECISION_INVENTORY> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_INVENTORY] true -> eventually(<+PUBLISH_DECISION_INVENTORY> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_registry_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_REGISTRY_REVIEW] true -> eventually(<+MEASURE_DECISION_REGISTRY> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_REGISTRY] true -> eventually(<+APPROVE_DECISION_REGISTRY> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_REGISTRY] true -> eventually(<+PUBLISH_DECISION_REGISTRY> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_ledger_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_LEDGER_REVIEW] true -> eventually(<+MEASURE_DECISION_LEDGER> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_LEDGER] true -> eventually(<+APPROVE_DECISION_LEDGER> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_log_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_LOG_REVIEW] true -> eventually(<+MEASURE_DECISION_LOG> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_LOG] true -> eventually(<+APPROVE_DECISION_LOG> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_LOG] true -> eventually(<+PUBLISH_DECISION_LOG> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_journal_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_JOURNAL_REVIEW] true -> eventually(<+MEASURE_DECISION_JOURNAL> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_JOURNAL] true -> eventually(<+APPROVE_DECISION_JOURNAL> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_timeline_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_TIMELINE_REVIEW] true -> eventually(<+MEASURE_DECISION_TIMELINE> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_TIMELINE] true -> eventually(<+APPROVE_DECISION_TIMELINE> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_TIMELINE] true -> eventually(<+PUBLISH_DECISION_TIMELINE> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_docket_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_DOCKET_REVIEW] true -> eventually(<+MEASURE_DECISION_DOCKET> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_DOCKET] true -> eventually(<+APPROVE_DECISION_DOCKET> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_agenda_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_AGENDA_REVIEW] true -> eventually(<+MEASURE_DECISION_AGENDA> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_AGENDA] true -> eventually(<+APPROVE_DECISION_AGENDA> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_schedule_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SCHEDULE_REVIEW] true -> eventually(<+MEASURE_DECISION_SCHEDULE> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SCHEDULE] true -> eventually(<+APPROVE_DECISION_SCHEDULE> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SCHEDULE] true -> eventually(<+PUBLISH_DECISION_SCHEDULE> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_calendar_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_CALENDAR_REVIEW] true -> eventually(<+MEASURE_DECISION_CALENDAR> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_CALENDAR] true -> eventually(<+APPROVE_DECISION_CALENDAR> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_CALENDAR] true -> eventually(<+PUBLISH_DECISION_CALENDAR> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_timetable_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_TIMETABLE_REVIEW] true -> eventually(<+MEASURE_DECISION_TIMETABLE> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_TIMETABLE] true -> eventually(<+APPROVE_DECISION_TIMETABLE> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_TIMETABLE] true -> eventually(<+PUBLISH_DECISION_TIMETABLE> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_roadmap_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_ROADMAP_REVIEW] true -> eventually(<+MEASURE_DECISION_ROADMAP> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_ROADMAP] true -> eventually(<+APPROVE_DECISION_ROADMAP> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_ROADMAP] true -> eventually(<+PUBLISH_DECISION_ROADMAP> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_plan_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_PLAN_REVIEW] true -> eventually(<+MEASURE_DECISION_PLAN> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_PLAN] true -> eventually(<+APPROVE_DECISION_PLAN> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_tactic_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_TACTIC_REVIEW] true -> eventually(<+MEASURE_DECISION_TACTIC> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_TACTIC] true -> eventually(<+APPROVE_DECISION_TACTIC> true))"
        ));
        assert!(output.contains(
    ...
    #[test]
    fn synthesis_list_includes_decision_operation_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_OPERATION_REVIEW] true -> eventually(<+MEASURE_DECISION_OPERATION> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_OPERATION] true -> eventually(<+APPROVE_DECISION_OPERATION> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_OPERATION] true -> eventually(<+PUBLISH_DECISION_OPERATION> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_execution_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_EXECUTION_REVIEW] true -> eventually(<+MEASURE_DECISION_EXECUTION> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_EXECUTION] true -> eventually(<+APPROVE_DECISION_EXECUTION> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_EXECUTION] true -> eventually(<+PUBLISH_DECISION_EXECUTION> true))"
        ));
    }
    ...
    fn synthesis_list_includes_decision_production_readiness_ordering_examples() {
        ...
        assert!(output.contains(
            "always([+REQUEST_DECISION_PRODUCTION_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PRODUCTION_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_PRODUCTION_READINESS] true -> eventually(<+APPROVE_DECISION_PRODUCTION_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_PRODUCTION_READINESS] true -> eventually(<+PUBLISH_DECISION_PRODUCTION_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_operational_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_OPERATIONAL_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_OPERATIONAL_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_OPERATIONAL_READINESS] true -> eventually(<+APPROVE_DECISION_OPERATIONAL_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_OPERATIONAL_READINESS] true -> eventually(<+PUBLISH_DECISION_OPERATIONAL_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_service_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SERVICE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SERVICE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SERVICE_READINESS] true -> eventually(<+APPROVE_DECISION_SERVICE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SERVICE_READINESS] true -> eventually(<+PUBLISH_DECISION_SERVICE_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_support_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SUPPORT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SUPPORT_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SUPPORT_READINESS] true -> eventually(<+APPROVE_DECISION_SUPPORT_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SUPPORT_READINESS] true -> eventually(<+PUBLISH_DECISION_SUPPORT_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_customer_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_CUSTOMER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CUSTOMER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_CUSTOMER_READINESS] true -> eventually(<+APPROVE_DECISION_CUSTOMER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_CUSTOMER_READINESS] true -> eventually(<+PUBLISH_DECISION_CUSTOMER_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_stakeholder_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_STAKEHOLDER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_STAKEHOLDER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_STAKEHOLDER_READINESS] true -> eventually(<+APPROVE_DECISION_STAKEHOLDER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_STAKEHOLDER_READINESS] true -> eventually(<+PUBLISH_DECISION_STAKEHOLDER_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_partner_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_PARTNER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PARTNER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_PARTNER_READINESS] true -> eventually(<+APPROVE_DECISION_PARTNER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_PARTNER_READINESS] true -> eventually(<+PUBLISH_DECISION_PARTNER_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_market_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_MARKET_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MARKET_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_MARKET_READINESS] true -> eventually(<+APPROVE_DECISION_MARKET_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_MARKET_READINESS] true -> eventually(<+PUBLISH_DECISION_MARKET_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_sales_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SALES_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SALES_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SALES_READINESS] true -> eventually(<+APPROVE_DECISION_SALES_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SALES_READINESS] true -> eventually(<+PUBLISH_DECISION_SALES_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_revenue_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_REVENUE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_REVENUE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_REVENUE_READINESS] true -> eventually(<+APPROVE_DECISION_REVENUE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_REVENUE_READINESS] true -> eventually(<+PUBLISH_DECISION_REVENUE_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_margin_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_MARGIN_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MARGIN_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_MARGIN_READINESS] true -> eventually(<+APPROVE_DECISION_MARGIN_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_MARGIN_READINESS] true -> eventually(<+PUBLISH_DECISION_MARGIN_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_profit_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_PROFIT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PROFIT_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_PROFIT_READINESS] true -> eventually(<+APPROVE_DECISION_PROFIT_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_PROFIT_READINESS] true -> eventually(<+PUBLISH_DECISION_PROFIT_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_cost_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_COST_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_COST_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_COST_READINESS] true -> eventually(<+APPROVE_DECISION_COST_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_COST_READINESS] true -> eventually(<+PUBLISH_DECISION_COST_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_value_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_VALUE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_VALUE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_VALUE_READINESS] true -> eventually(<+APPROVE_DECISION_VALUE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_VALUE_READINESS] true -> eventually(<+PUBLISH_DECISION_VALUE_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_growth_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_GROWTH_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_GROWTH_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_GROWTH_READINESS] true -> eventually(<+APPROVE_DECISION_GROWTH_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_GROWTH_READINESS] true -> eventually(<+PUBLISH_DECISION_GROWTH_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_pipeline_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_PIPELINE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PIPELINE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_PIPELINE_READINESS] true -> eventually(<+APPROVE_DECISION_PIPELINE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_PIPELINE_READINESS] true -> eventually(<+PUBLISH_DECISION_PIPELINE_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_forecast_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_FORECAST_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_FORECAST_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_FORECAST_READINESS] true -> eventually(<+APPROVE_DECISION_FORECAST_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_FORECAST_READINESS] true -> eventually(<+PUBLISH_DECISION_FORECAST_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_demand_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_DEMAND_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_DEMAND_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_DEMAND_READINESS] true -> eventually(<+APPROVE_DECISION_DEMAND_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_DEMAND_READINESS] true -> eventually(<+PUBLISH_DECISION_DEMAND_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_capacity_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_CAPACITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CAPACITY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_CAPACITY_READINESS] true -> eventually(<+APPROVE_DECISION_CAPACITY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_CAPACITY_READINESS] true -> eventually(<+PUBLISH_DECISION_CAPACITY_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_supply_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SUPPLY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SUPPLY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SUPPLY_READINESS] true -> eventually(<+APPROVE_DECISION_SUPPLY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SUPPLY_READINESS] true -> eventually(<+PUBLISH_DECISION_SUPPLY_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_logistics_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_LOGISTICS_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_LOGISTICS_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_LOGISTICS_READINESS] true -> eventually(<+APPROVE_DECISION_LOGISTICS_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_LOGISTICS_READINESS] true -> eventually(<+PUBLISH_DECISION_LOGISTICS_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_fulfillment_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_FULFILLMENT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_FULFILLMENT_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_FULFILLMENT_READINESS] true -> eventually(<+APPROVE_DECISION_FULFILLMENT_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_FULFILLMENT_READINESS] true -> eventually(<+PUBLISH_DECISION_FULFILLMENT_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_delivery_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_DELIVERY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_DELIVERY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_DELIVERY_READINESS] true -> eventually(<+APPROVE_DECISION_DELIVERY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_DELIVERY_READINESS] true -> eventually(<+PUBLISH_DECISION_DELIVERY_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_distribution_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_DISTRIBUTION_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_DISTRIBUTION_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_DISTRIBUTION_READINESS] true -> eventually(<+APPROVE_DECISION_DISTRIBUTION_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_DISTRIBUTION_READINESS] true -> eventually(<+PUBLISH_DECISION_DISTRIBUTION_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_channel_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_CHANNEL_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CHANNEL_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_CHANNEL_READINESS] true -> eventually(<+APPROVE_DECISION_CHANNEL_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_CHANNEL_READINESS] true -> eventually(<+PUBLISH_DECISION_CHANNEL_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_segment_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SEGMENT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SEGMENT_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SEGMENT_READINESS] true -> eventually(<+APPROVE_DECISION_SEGMENT_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SEGMENT_READINESS] true -> eventually(<+PUBLISH_DECISION_SEGMENT_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_territory_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_TERRITORY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_TERRITORY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_TERRITORY_READINESS] true -> eventually(<+APPROVE_DECISION_TERRITORY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_TERRITORY_READINESS] true -> eventually(<+PUBLISH_DECISION_TERRITORY_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_account_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_ACCOUNT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ACCOUNT_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_ACCOUNT_READINESS] true -> eventually(<+APPROVE_DECISION_ACCOUNT_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_ACCOUNT_READINESS] true -> eventually(<+PUBLISH_DECISION_ACCOUNT_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_opportunity_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_OPPORTUNITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_OPPORTUNITY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_OPPORTUNITY_READINESS] true -> eventually(<+APPROVE_DECISION_OPPORTUNITY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_OPPORTUNITY_READINESS] true -> eventually(<+PUBLISH_DECISION_OPPORTUNITY_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_deal_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_DEAL_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_DEAL_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_DEAL_READINESS] true -> eventually(<+APPROVE_DECISION_DEAL_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_DEAL_READINESS] true -> eventually(<+PUBLISH_DECISION_DEAL_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_quote_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_QUOTE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_QUOTE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_QUOTE_READINESS] true -> eventually(<+APPROVE_DECISION_QUOTE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_QUOTE_READINESS] true -> eventually(<+PUBLISH_DECISION_QUOTE_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_contract_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_CONTRACT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CONTRACT_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_CONTRACT_READINESS] true -> eventually(<+APPROVE_DECISION_CONTRACT_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_CONTRACT_READINESS] true -> eventually(<+PUBLISH_DECISION_CONTRACT_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_proposal_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_PROPOSAL_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PROPOSAL_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_PROPOSAL_READINESS] true -> eventually(<+APPROVE_DECISION_PROPOSAL_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_PROPOSAL_READINESS] true -> eventually(<+PUBLISH_DECISION_PROPOSAL_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_bid_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_BID_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_BID_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_BID_READINESS] true -> eventually(<+APPROVE_DECISION_BID_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_BID_READINESS] true -> eventually(<+PUBLISH_DECISION_BID_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_tender_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_TENDER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_TENDER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_TENDER_READINESS] true -> eventually(<+APPROVE_DECISION_TENDER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_TENDER_READINESS] true -> eventually(<+PUBLISH_DECISION_TENDER_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_procurement_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_PROCUREMENT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PROCUREMENT_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_PROCUREMENT_READINESS] true -> eventually(<+APPROVE_DECISION_PROCUREMENT_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_PROCUREMENT_READINESS] true -> eventually(<+PUBLISH_DECISION_PROCUREMENT_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_sourcing_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SOURCING_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SOURCING_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SOURCING_READINESS] true -> eventually(<+APPROVE_DECISION_SOURCING_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SOURCING_READINESS] true -> eventually(<+PUBLISH_DECISION_SOURCING_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_supplier_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SUPPLIER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SUPPLIER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SUPPLIER_READINESS] true -> eventually(<+APPROVE_DECISION_SUPPLIER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SUPPLIER_READINESS] true -> eventually(<+PUBLISH_DECISION_SUPPLIER_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_vendor_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_VENDOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_VENDOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_VENDOR_READINESS] true -> eventually(<+APPROVE_DECISION_VENDOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_VENDOR_READINESS] true -> eventually(<+PUBLISH_DECISION_VENDOR_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_contractor_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_CONTRACTOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CONTRACTOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_CONTRACTOR_READINESS] true -> eventually(<+APPROVE_DECISION_CONTRACTOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_CONTRACTOR_READINESS] true -> eventually(<+PUBLISH_DECISION_CONTRACTOR_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_consultant_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_CONSULTANT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CONSULTANT_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_CONSULTANT_READINESS] true -> eventually(<+APPROVE_DECISION_CONSULTANT_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_CONSULTANT_READINESS] true -> eventually(<+PUBLISH_DECISION_CONSULTANT_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_advisor_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_ADVISOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ADVISOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_ADVISOR_READINESS] true -> eventually(<+APPROVE_DECISION_ADVISOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_ADVISOR_READINESS] true -> eventually(<+PUBLISH_DECISION_ADVISOR_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_expert_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_EXPERT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_EXPERT_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_EXPERT_READINESS] true -> eventually(<+APPROVE_DECISION_EXPERT_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_EXPERT_READINESS] true -> eventually(<+PUBLISH_DECISION_EXPERT_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_specialist_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SPECIALIST_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SPECIALIST_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SPECIALIST_READINESS] true -> eventually(<+APPROVE_DECISION_SPECIALIST_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SPECIALIST_READINESS] true -> eventually(<+PUBLISH_DECISION_SPECIALIST_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_practitioner_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_PRACTITIONER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PRACTITIONER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_PRACTITIONER_READINESS] true -> eventually(<+APPROVE_DECISION_PRACTITIONER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_PRACTITIONER_READINESS] true -> eventually(<+PUBLISH_DECISION_PRACTITIONER_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_technician_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_TECHNICIAN_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_TECHNICIAN_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_TECHNICIAN_READINESS] true -> eventually(<+APPROVE_DECISION_TECHNICIAN_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_TECHNICIAN_READINESS] true -> eventually(<+PUBLISH_DECISION_TECHNICIAN_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_engineer_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_ENGINEER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ENGINEER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_ENGINEER_READINESS] true -> eventually(<+APPROVE_DECISION_ENGINEER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_ENGINEER_READINESS] true -> eventually(<+PUBLISH_DECISION_ENGINEER_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_operator_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_OPERATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_OPERATOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_OPERATOR_READINESS] true -> eventually(<+APPROVE_DECISION_OPERATOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_OPERATOR_READINESS] true -> eventually(<+PUBLISH_DECISION_OPERATOR_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_analyst_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_ANALYST_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ANALYST_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_ANALYST_READINESS] true -> eventually(<+APPROVE_DECISION_ANALYST_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_ANALYST_READINESS] true -> eventually(<+PUBLISH_DECISION_ANALYST_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_coordinator_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_COORDINATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_COORDINATOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_COORDINATOR_READINESS] true -> eventually(<+APPROVE_DECISION_COORDINATOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_COORDINATOR_READINESS] true -> eventually(<+PUBLISH_DECISION_COORDINATOR_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_facilitator_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_FACILITATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_FACILITATOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_FACILITATOR_READINESS] true -> eventually(<+APPROVE_DECISION_FACILITATOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_FACILITATOR_READINESS] true -> eventually(<+PUBLISH_DECISION_FACILITATOR_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_mediator_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_MEDIATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MEDIATOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_MEDIATOR_READINESS] true -> eventually(<+APPROVE_DECISION_MEDIATOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_MEDIATOR_READINESS] true -> eventually(<+PUBLISH_DECISION_MEDIATOR_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_arbitrator_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_ARBITRATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ARBITRATOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_ARBITRATOR_READINESS] true -> eventually(<+APPROVE_DECISION_ARBITRATOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_ARBITRATOR_READINESS] true -> eventually(<+PUBLISH_DECISION_ARBITRATOR_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_judge_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_JUDGE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_JUDGE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_JUDGE_READINESS] true -> eventually(<+APPROVE_DECISION_JUDGE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_JUDGE_READINESS] true -> eventually(<+PUBLISH_DECISION_JUDGE_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_magistrate_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_MAGISTRATE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MAGISTRATE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_MAGISTRATE_READINESS] true -> eventually(<+APPROVE_DECISION_MAGISTRATE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_MAGISTRATE_READINESS] true -> eventually(<+PUBLISH_DECISION_MAGISTRATE_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_adjudicator_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_ADJUDICATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ADJUDICATOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_ADJUDICATOR_READINESS] true -> eventually(<+APPROVE_DECISION_ADJUDICATOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_ADJUDICATOR_READINESS] true -> eventually(<+PUBLISH_DECISION_ADJUDICATOR_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_ombudsman_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_OMBUDSMAN_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_OMBUDSMAN_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_OMBUDSMAN_READINESS] true -> eventually(<+APPROVE_DECISION_OMBUDSMAN_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_OMBUDSMAN_READINESS] true -> eventually(<+PUBLISH_DECISION_OMBUDSMAN_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_referee_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_REFEREE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_REFEREE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_REFEREE_READINESS] true -> eventually(<+APPROVE_DECISION_REFEREE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_REFEREE_READINESS] true -> eventually(<+PUBLISH_DECISION_REFEREE_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_umpire_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_UMPIRE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_UMPIRE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_UMPIRE_READINESS] true -> eventually(<+APPROVE_DECISION_UMPIRE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_UMPIRE_READINESS] true -> eventually(<+PUBLISH_DECISION_UMPIRE_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_moderator_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_MODERATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MODERATOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_MODERATOR_READINESS] true -> eventually(<+APPROVE_DECISION_MODERATOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_MODERATOR_READINESS] true -> eventually(<+PUBLISH_DECISION_MODERATOR_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_reviewer_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_REVIEWER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_REVIEWER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_REVIEWER_READINESS] true -> eventually(<+APPROVE_DECISION_REVIEWER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_REVIEWER_READINESS] true -> eventually(<+PUBLISH_DECISION_REVIEWER_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_assessor_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_ASSESSOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ASSESSOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_ASSESSOR_READINESS] true -> eventually(<+APPROVE_DECISION_ASSESSOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_ASSESSOR_READINESS] true -> eventually(<+PUBLISH_DECISION_ASSESSOR_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_evaluator_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_EVALUATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_EVALUATOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_EVALUATOR_READINESS] true -> eventually(<+APPROVE_DECISION_EVALUATOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_EVALUATOR_READINESS] true -> eventually(<+PUBLISH_DECISION_EVALUATOR_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_auditor_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_AUDITOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_AUDITOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_AUDITOR_READINESS] true -> eventually(<+APPROVE_DECISION_AUDITOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_AUDITOR_READINESS] true -> eventually(<+PUBLISH_DECISION_AUDITOR_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_inspector_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_INSPECTOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_INSPECTOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_INSPECTOR_READINESS] true -> eventually(<+APPROVE_DECISION_INSPECTOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_INSPECTOR_READINESS] true -> eventually(<+PUBLISH_DECISION_INSPECTOR_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_examiner_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_EXAMINER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_EXAMINER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_EXAMINER_READINESS] true -> eventually(<+APPROVE_DECISION_EXAMINER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_EXAMINER_READINESS] true -> eventually(<+PUBLISH_DECISION_EXAMINER_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_monitor_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_MONITOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MONITOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_MONITOR_READINESS] true -> eventually(<+APPROVE_DECISION_MONITOR_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_MONITOR_READINESS] true -> eventually(<+PUBLISH_DECISION_MONITOR_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_observer_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_OBSERVER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_OBSERVER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_OBSERVER_READINESS] true -> eventually(<+APPROVE_DECISION_OBSERVER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_OBSERVER_READINESS] true -> eventually(<+PUBLISH_DECISION_OBSERVER_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_watcher_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_WATCHER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_WATCHER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_WATCHER_READINESS] true -> eventually(<+APPROVE_DECISION_WATCHER_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_WATCHER_READINESS] true -> eventually(<+PUBLISH_DECISION_WATCHER_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_sentinel_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SENTINEL_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SENTINEL_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SENTINEL_READINESS] true -> eventually(<+APPROVE_DECISION_SENTINEL_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SENTINEL_READINESS] true -> eventually(<+PUBLISH_DECISION_SENTINEL_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_guardian_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_GUARDIAN_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_GUARDIAN_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_GUARDIAN_READINESS] true -> eventually(<+APPROVE_DECISION_GUARDIAN_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_GUARDIAN_READINESS] true -> eventually(<+PUBLISH_DECISION_GUARDIAN_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_custodian_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_CUSTODIAN_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CUSTODIAN_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_CUSTODIAN_READINESS] true -> eventually(<+APPROVE_DECISION_CUSTODIAN_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_CUSTODIAN_READINESS] true -> eventually(<+PUBLISH_DECISION_CUSTODIAN_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_steward_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_STEWARD_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_STEWARD_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_STEWARD_READINESS] true -> eventually(<+APPROVE_DECISION_STEWARD_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_STEWARD_READINESS] true -> eventually(<+PUBLISH_DECISION_STEWARD_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_trustee_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_TRUSTEE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_TRUSTEE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_TRUSTEE_READINESS] true -> eventually(<+APPROVE_DECISION_TRUSTEE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_TRUSTEE_READINESS] true -> eventually(<+PUBLISH_DECISION_TRUSTEE_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_fiduciary_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_FIDUCIARY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_FIDUCIARY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_FIDUCIARY_READINESS] true -> eventually(<+APPROVE_DECISION_FIDUCIARY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_FIDUCIARY_READINESS] true -> eventually(<+PUBLISH_DECISION_FIDUCIARY_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_compliance_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_COMPLIANCE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_COMPLIANCE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_COMPLIANCE_READINESS] true -> eventually(<+APPROVE_DECISION_COMPLIANCE_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_COMPLIANCE_READINESS] true -> eventually(<+PUBLISH_DECISION_COMPLIANCE_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_risk_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_RISK_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_RISK_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_RISK_READINESS] true -> eventually(<+APPROVE_DECISION_RISK_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_RISK_READINESS] true -> eventually(<+PUBLISH_DECISION_RISK_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_safety_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SAFETY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SAFETY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SAFETY_READINESS] true -> eventually(<+APPROVE_DECISION_SAFETY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SAFETY_READINESS] true -> eventually(<+PUBLISH_DECISION_SAFETY_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_security_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SECURITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SECURITY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SECURITY_READINESS] true -> eventually(<+APPROVE_DECISION_SECURITY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SECURITY_READINESS] true -> eventually(<+PUBLISH_DECISION_SECURITY_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_privacy_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_PRIVACY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PRIVACY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_PRIVACY_READINESS] true -> eventually(<+APPROVE_DECISION_PRIVACY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_PRIVACY_READINESS] true -> eventually(<+PUBLISH_DECISION_PRIVACY_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_data_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_DATA_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_DATA_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_DATA_READINESS] true -> eventually(<+APPROVE_DECISION_DATA_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_DATA_READINESS] true -> eventually(<+PUBLISH_DECISION_DATA_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_ai_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_AI_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_AI_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_AI_READINESS] true -> eventually(<+APPROVE_DECISION_AI_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_AI_READINESS] true -> eventually(<+PUBLISH_DECISION_AI_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_ml_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_ML_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ML_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_ML_READINESS] true -> eventually(<+APPROVE_DECISION_ML_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_ML_READINESS] true -> eventually(<+PUBLISH_DECISION_ML_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_model_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_MODEL_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MODEL_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_MODEL_READINESS] true -> eventually(<+APPROVE_DECISION_MODEL_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_MODEL_READINESS] true -> eventually(<+PUBLISH_DECISION_MODEL_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_algorithm_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_ALGORITHM_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ALGORITHM_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_ALGORITHM_READINESS] true -> eventually(<+APPROVE_DECISION_ALGORITHM_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_ALGORITHM_READINESS] true -> eventually(<+PUBLISH_DECISION_ALGORITHM_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_automation_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_AUTOMATION_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_AUTOMATION_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_AUTOMATION_READINESS] true -> eventually(<+APPROVE_DECISION_AUTOMATION_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_AUTOMATION_READINESS] true -> eventually(<+PUBLISH_DECISION_AUTOMATION_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_orchestration_readiness_ordering_examples() {
        let output = synthesis_list_text();
        ...
        assert!(output.contains(
            "always([+MEASURE_DECISION_ORCHESTRATION_READINESS] true -> eventually(<+APPROVE_DECISION_ORCHESTRATION_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_ORCHESTRATION_READINESS] true -> eventually(<+PUBLISH_DECISION_ORCHESTRATION_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_coordination_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_COORDINATION_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_COORDINATION_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_COORDINATION_READINESS] true -> eventually(<+APPROVE_DECISION_COORDINATION_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_COORDINATION_READINESS] true -> eventually(<+PUBLISH_DECISION_COORDINATION_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_collaboration_readiness_ordering_examples() {
        let output = synthesis_list_text();
        ...
        assert!(output.contains(
            "always([+MEASURE_DECISION_COLLABORATION_READINESS] true -> eventually(<+APPROVE_DECISION_COLLABORATION_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_COLLABORATION_READINESS] true -> eventually(<+PUBLISH_DECISION_COLLABORATION_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_integration_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_INTEGRATION_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_INTEGRATION_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_INTEGRATION_READINESS] true -> eventually(<+APPROVE_DECISION_INTEGRATION_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_INTEGRATION_READINESS] true -> eventually(<+PUBLISH_DECISION_INTEGRATION_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_interoperability_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_INTEROPERABILITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_INTEROPERABILITY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_INTEROPERABILITY_READINESS] true -> eventually(<+APPROVE_DECISION_INTEROPERABILITY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_INTEROPERABILITY_READINESS] true -> eventually(<+PUBLISH_DECISION_INTEROPERABILITY_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_compatibility_readiness_ordering_examples() {
        let output = synthesis_list_text();
        ...
        assert!(output.contains(
            "always([+MEASURE_DECISION_COMPATIBILITY_READINESS] true -> eventually(<+APPROVE_DECISION_COMPATIBILITY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_COMPATIBILITY_READINESS] true -> eventually(<+PUBLISH_DECISION_COMPATIBILITY_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_portability_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_PORTABILITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PORTABILITY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_PORTABILITY_READINESS] true -> eventually(<+APPROVE_DECISION_PORTABILITY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_PORTABILITY_READINESS] true -> eventually(<+PUBLISH_DECISION_PORTABILITY_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_transferability_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_TRANSFERABILITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_TRANSFERABILITY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_TRANSFERABILITY_READINESS] true -> eventually(<+APPROVE_DECISION_TRANSFERABILITY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_TRANSFERABILITY_READINESS] true -> eventually(<+PUBLISH_DECISION_TRANSFERABILITY_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_assignability_readiness_ordering_examples() {
        let output = synthesis_list_text();
        ...
        assert!(output.contains(
            "always([+MEASURE_DECISION_ASSIGNABILITY_READINESS] true -> eventually(<+APPROVE_DECISION_ASSIGNABILITY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_ASSIGNABILITY_READINESS] true -> eventually(<+PUBLISH_DECISION_ASSIGNABILITY_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_mobility_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_MOBILITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MOBILITY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_MOBILITY_READINESS] true -> eventually(<+APPROVE_DECISION_MOBILITY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_MOBILITY_READINESS] true -> eventually(<+PUBLISH_DECISION_MOBILITY_READINESS> true))"
        ));
    }

    #[test]
    fn synthesis_list_includes_decision_scalability_readiness_ordering_examples() {
        let output = synthesis_list_text();

        assert!(output.contains(
            "always([+REQUEST_DECISION_SCALABILITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SCALABILITY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+MEASURE_DECISION_SCALABILITY_READINESS] true -> eventually(<+APPROVE_DECISION_SCALABILITY_READINESS> true))"
        ));
        assert!(output.contains(
            "always([+APPROVE_DECISION_SCALABILITY_READINESS] true -> eventually(<+PUBLISH_DECISION_SCALABILITY_READINESS> true))"
        ));
    }
    ...
    #[test]
    fn synthesis_list_includes_operational_action_prompt_examples() {
        let output = synthesis_list_text();
...
"#
    ...
    #[test]
    fn verify_synthesized_model_accepts_agent_benchmark_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_AGENT_BENCHMARK_CHANGE] true -> eventually(<+RUN_AGENT_BENCHMARK> true))"
                .to_string(),
            "always([+RUN_AGENT_BENCHMARK] true -> eventually(<+APPROVE_AGENT_BENCHMARK_CHANGE> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_agent_eval_dataset_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_AGENT_EVAL_DATASET_CHANGE] true -> eventually(<+REVIEW_AGENT_EVAL_DATASET> true))"
                .to_string(),
            "always([+REVIEW_AGENT_EVAL_DATASET] true -> eventually(<+APPROVE_AGENT_EVAL_DATASET_CHANGE> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_agent_alert_rule_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_AGENT_ALERT_RULE_CHANGE] true -> eventually(<+REVIEW_AGENT_ALERT_RULE> true))"
                .to_string(),
            "always([+REVIEW_AGENT_ALERT_RULE] true -> eventually(<+APPROVE_AGENT_ALERT_RULE_CHANGE> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_agent_escalation_policy_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_AGENT_ESCALATION_POLICY_CHANGE] true -> eventually(<+REVIEW_AGENT_ESCALATION_POLICY> true))"
                .to_string(),
            "always([+REVIEW_AGENT_ESCALATION_POLICY] true -> eventually(<+APPROVE_AGENT_ESCALATION_POLICY_CHANGE> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_agent_notification_policy_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_AGENT_NOTIFICATION_POLICY_CHANGE] true -> eventually(<+REVIEW_AGENT_NOTIFICATION_POLICY> true))"
                .to_string(),
            "always([+REVIEW_AGENT_NOTIFICATION_POLICY] true -> eventually(<+APPROVE_AGENT_NOTIFICATION_POLICY_CHANGE> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_agent_heartbeat_policy_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_AGENT_HEARTBEAT_POLICY_CHANGE] true -> eventually(<+REVIEW_AGENT_HEARTBEAT_POLICY> true))"
                .to_string(),
            "always([+REVIEW_AGENT_HEARTBEAT_POLICY] true -> eventually(<+APPROVE_AGENT_HEARTBEAT_POLICY_CHANGE> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_agent_quiet_hours_policy_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_AGENT_QUIET_HOURS_POLICY_CHANGE] true -> eventually(<+REVIEW_AGENT_QUIET_HOURS_POLICY> true))"
                .to_string(),
            "always([+REVIEW_AGENT_QUIET_HOURS_POLICY] true -> eventually(<+APPROVE_AGENT_QUIET_HOURS_POLICY_CHANGE> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_agent_reminder_policy_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_AGENT_REMINDER_POLICY_CHANGE] true -> eventually(<+REVIEW_AGENT_REMINDER_POLICY> true))"
                .to_string(),
            "always([+REVIEW_AGENT_REMINDER_POLICY] true -> eventually(<+APPROVE_AGENT_REMINDER_POLICY_CHANGE> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_agent_digest_policy_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_AGENT_DIGEST_POLICY_CHANGE] true -> eventually(<+REVIEW_AGENT_DIGEST_POLICY> true))"
                .to_string(),
            "always([+REVIEW_AGENT_DIGEST_POLICY] true -> eventually(<+APPROVE_AGENT_DIGEST_POLICY_CHANGE> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_retention_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_RETENTION_REVIEW] true -> eventually(<+CLASSIFY_DECISION_RECORDS> true))"
                .to_string(),
            "always([+CLASSIFY_DECISION_RECORDS] true -> eventually(<+APPROVE_DECISION_RETENTION> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_disclosure_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_DISCLOSURE] true -> eventually(<+REVIEW_DECISION_DISCLOSURE_SCOPE> true))"
                .to_string(),
            "always([+REVIEW_DECISION_DISCLOSURE_SCOPE] true -> eventually(<+APPROVE_DECISION_DISCLOSURE> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_portability_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_PORTABILITY] true -> eventually(<+VERIFY_DECISION_PORTABILITY_SCOPE> true))"
                .to_string(),
            "always([+VERIFY_DECISION_PORTABILITY_SCOPE] true -> eventually(<+APPROVE_DECISION_PORTABILITY> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_provenance_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_PROVENANCE] true -> eventually(<+TRACE_DECISION_INPUTS> true))"
                .to_string(),
            "always([+TRACE_DECISION_INPUTS] true -> eventually(<+APPROVE_DECISION_PROVENANCE> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_transparency_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_TRANSPARENCY_REVIEW] true -> eventually(<+COLLECT_DECISION_TRANSPARENCY_EVIDENCE> true))"
                .to_string(),
            "always([+COLLECT_DECISION_TRANSPARENCY_EVIDENCE] true -> eventually(<+APPROVE_DECISION_TRANSPARENCY> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_rationale_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_RATIONALE] true -> eventually(<+ASSEMBLE_DECISION_RATIONALE> true))"
                .to_string(),
            "always([+ASSEMBLE_DECISION_RATIONALE] true -> eventually(<+APPROVE_DECISION_RATIONALE> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_threshold_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_THRESHOLD_REVIEW] true -> eventually(<+ANALYZE_DECISION_THRESHOLDS> true))"
                .to_string(),
            "always([+ANALYZE_DECISION_THRESHOLDS] true -> eventually(<+APPROVE_DECISION_THRESHOLD_UPDATE> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_policy_exception_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_POLICY_EXCEPTION] true -> eventually(<+ASSESS_DECISION_POLICY_RISK> true))"
                .to_string(),
            "always([+ASSESS_DECISION_POLICY_RISK] true -> eventually(<+APPROVE_DECISION_POLICY_EXCEPTION> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_reliability_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_RELIABILITY_REVIEW] true -> eventually(<+MEASURE_DECISION_RELIABILITY> true))"
                .to_string(),
            "always([+MEASURE_DECISION_RELIABILITY] true -> eventually(<+APPROVE_DECISION_RELIABILITY_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_robustness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_ROBUSTNESS_REVIEW] true -> eventually(<+TEST_DECISION_ROBUSTNESS> true))"
                .to_string(),
            "always([+TEST_DECISION_ROBUSTNESS] true -> eventually(<+APPROVE_DECISION_ROBUSTNESS_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_consistency_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_CONSISTENCY_REVIEW] true -> eventually(<+COMPARE_DECISION_CONSISTENCY> true))"
                .to_string(),
            "always([+COMPARE_DECISION_CONSISTENCY] true -> eventually(<+APPROVE_DECISION_CONSISTENCY_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_accuracy_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_ACCURACY_REVIEW] true -> eventually(<+MEASURE_DECISION_ACCURACY> true))"
                .to_string(),
            "always([+MEASURE_DECISION_ACCURACY] true -> eventually(<+APPROVE_DECISION_ACCURACY_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_precision_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_PRECISION_REVIEW] true -> eventually(<+MEASURE_DECISION_PRECISION> true))"
                .to_string(),
            "always([+MEASURE_DECISION_PRECISION] true -> eventually(<+APPROVE_DECISION_PRECISION_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_recall_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_RECALL_REVIEW] true -> eventually(<+MEASURE_DECISION_RECALL> true))"
                .to_string(),
            "always([+MEASURE_DECISION_RECALL] true -> eventually(<+APPROVE_DECISION_RECALL_REPORT> true))"
        ...
        let model =
            modality_lang::formula_synthesis::synthesize_from_formulas("DecisionRecall", &formulas);

        verify_synthesized_model(&model, &formulas).unwrap();
    }

    #[test]
    fn verify_synthesized_model_accepts_decision_specificity_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SPECIFICITY_REVIEW] true -> eventually(<+MEASURE_DECISION_SPECIFICITY> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SPECIFICITY] true -> eventually(<+APPROVE_DECISION_SPECIFICITY_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_sensitivity_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SENSITIVITY_REVIEW] true -> eventually(<+MEASURE_DECISION_SENSITIVITY> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SENSITIVITY] true -> eventually(<+APPROVE_DECISION_SENSITIVITY_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_selectivity_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SELECTIVITY_REVIEW] true -> eventually(<+MEASURE_DECISION_SELECTIVITY> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SELECTIVITY] true -> eventually(<+APPROVE_DECISION_SELECTIVITY_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_prevalence_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_PREVALENCE_REVIEW] true -> eventually(<+MEASURE_DECISION_PREVALENCE> true))"
                .to_string(),
            "always([+MEASURE_DECISION_PREVALENCE] true -> eventually(<+APPROVE_DECISION_PREVALENCE_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_incidence_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_INCIDENCE_REVIEW] true -> eventually(<+MEASURE_DECISION_INCIDENCE> true))"
                .to_string(),
            "always([+MEASURE_DECISION_INCIDENCE] true -> eventually(<+APPROVE_DECISION_INCIDENCE_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_lift_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_LIFT_REVIEW] true -> eventually(<+MEASURE_DECISION_LIFT> true))"
                .to_string(),
            "always([+MEASURE_DECISION_LIFT] true -> eventually(<+APPROVE_DECISION_LIFT_REPORT> true))"
        ...
        let model =
            modality_lang::formula_synthesis::synthesize_from_formulas("DecisionLift", &formulas);

        verify_synthesized_model(&model, &formulas).unwrap();
    }

    #[test]
    fn verify_synthesized_model_accepts_decision_gain_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_GAIN_REVIEW] true -> eventually(<+MEASURE_DECISION_GAIN> true))"
                .to_string(),
            "always([+MEASURE_DECISION_GAIN] true -> eventually(<+APPROVE_DECISION_GAIN_REPORT> true))"
        ...
        let model =
            modality_lang::formula_synthesis::synthesize_from_formulas("DecisionGain", &formulas);

        verify_synthesized_model(&model, &formulas).unwrap();
    }

    #[test]
    fn verify_synthesized_model_accepts_decision_odds_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_ODDS_REVIEW] true -> eventually(<+MEASURE_DECISION_ODDS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_ODDS] true -> eventually(<+APPROVE_DECISION_ODDS_REPORT> true))"
        ...
        let model =
            modality_lang::formula_synthesis::synthesize_from_formulas("DecisionOdds", &formulas);

        verify_synthesized_model(&model, &formulas).unwrap();
    }

    #[test]
    fn verify_synthesized_model_accepts_decision_risk_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_RISK_REVIEW] true -> eventually(<+MEASURE_DECISION_RISK> true))"
                .to_string(),
            "always([+MEASURE_DECISION_RISK] true -> eventually(<+APPROVE_DECISION_RISK_REPORT> true))"
        ...
        let model =
            modality_lang::formula_synthesis::synthesize_from_formulas("DecisionRisk", &formulas);

        verify_synthesized_model(&model, &formulas).unwrap();
    }

    #[test]
    fn verify_synthesized_model_accepts_decision_exposure_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_EXPOSURE_REVIEW] true -> eventually(<+MEASURE_DECISION_EXPOSURE> true))"
                .to_string(),
            "always([+MEASURE_DECISION_EXPOSURE] true -> eventually(<+APPROVE_DECISION_EXPOSURE_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_harm_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_HARM_REVIEW] true -> eventually(<+MEASURE_DECISION_HARM> true))"
                .to_string(),
            "always([+MEASURE_DECISION_HARM] true -> eventually(<+APPROVE_DECISION_HARM_REPORT> true))"
        ...
        let model =
            modality_lang::formula_synthesis::synthesize_from_formulas("DecisionHarm", &formulas);

        verify_synthesized_model(&model, &formulas).unwrap();
    }

    #[test]
    fn verify_synthesized_model_accepts_decision_loss_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_LOSS_REVIEW] true -> eventually(<+MEASURE_DECISION_LOSS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_LOSS] true -> eventually(<+APPROVE_DECISION_LOSS_REPORT> true))"
        ...
        let model =
            modality_lang::formula_synthesis::synthesize_from_formulas("DecisionLoss", &formulas);

        verify_synthesized_model(&model, &formulas).unwrap();
    }

    #[test]
    fn verify_synthesized_model_accepts_decision_severity_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SEVERITY_REVIEW] true -> eventually(<+MEASURE_DECISION_SEVERITY> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SEVERITY] true -> eventually(<+APPROVE_DECISION_SEVERITY_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_cost_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_COST_REVIEW] true -> eventually(<+MEASURE_DECISION_COST> true))"
                .to_string(),
            "always([+MEASURE_DECISION_COST] true -> eventually(<+APPROVE_DECISION_COST_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_value_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_VALUE_REVIEW] true -> eventually(<+MEASURE_DECISION_VALUE> true))"
                .to_string(),
            "always([+MEASURE_DECISION_VALUE] true -> eventually(<+APPROVE_DECISION_VALUE_REPORT> true))"
        ...
        let model =
            modality_lang::formula_synthesis::synthesize_from_formulas("DecisionValue", &formulas);

        verify_synthesized_model(&model, &formulas).unwrap();
    }

    #[test]
    fn verify_synthesized_model_accepts_decision_utility_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_UTILITY_REVIEW] true -> eventually(<+MEASURE_DECISION_UTILITY> true))"
                .to_string(),
            "always([+MEASURE_DECISION_UTILITY] true -> eventually(<+APPROVE_DECISION_UTILITY_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_rank_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_RANK_REVIEW] true -> eventually(<+MEASURE_DECISION_RANK> true))"
                .to_string(),
            "always([+MEASURE_DECISION_RANK] true -> eventually(<+APPROVE_DECISION_RANK_REPORT> true))"
        ...
        let model =
            modality_lang::formula_synthesis::synthesize_from_formulas("DecisionRank", &formulas);

        verify_synthesized_model(&model, &formulas).unwrap();
    }

    #[test]
    fn verify_synthesized_model_accepts_decision_score_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SCORE_REVIEW] true -> eventually(<+MEASURE_DECISION_SCORE> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SCORE] true -> eventually(<+APPROVE_DECISION_SCORE_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_influence_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_INFLUENCE_REVIEW] true -> eventually(<+MEASURE_DECISION_INFLUENCE> true))"
                .to_string(),
            "always([+MEASURE_DECISION_INFLUENCE] true -> eventually(<+APPROVE_DECISION_INFLUENCE_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_contribution_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_CONTRIBUTION_REVIEW] true -> eventually(<+MEASURE_DECISION_CONTRIBUTION> true))"
                .to_string(),
            "always([+MEASURE_DECISION_CONTRIBUTION] true -> eventually(<+APPROVE_DECISION_CONTRIBUTION_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_importance_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_IMPORTANCE_REVIEW] true -> eventually(<+MEASURE_DECISION_IMPORTANCE> true))"
                .to_string(),
            "always([+MEASURE_DECISION_IMPORTANCE] true -> eventually(<+APPROVE_DECISION_IMPORTANCE_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_salience_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SALIENCE_REVIEW] true -> eventually(<+MEASURE_DECISION_SALIENCE> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SALIENCE] true -> eventually(<+APPROVE_DECISION_SALIENCE_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_relevance_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_RELEVANCE_REVIEW] true -> eventually(<+MEASURE_DECISION_RELEVANCE> true))"
                .to_string(),
            "always([+MEASURE_DECISION_RELEVANCE] true -> eventually(<+APPROVE_DECISION_RELEVANCE_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_pertinence_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_PERTINENCE_REVIEW] true -> eventually(<+MEASURE_DECISION_PERTINENCE> true))"
                .to_string(),
            "always([+MEASURE_DECISION_PERTINENCE] true -> eventually(<+APPROVE_DECISION_PERTINENCE_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_applicability_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_APPLICABILITY_REVIEW] true -> eventually(<+MEASURE_DECISION_APPLICABILITY> true))"
                .to_string(),
            "always([+MEASURE_DECISION_APPLICABILITY] true -> eventually(<+APPROVE_DECISION_APPLICABILITY_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_suitability_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SUITABILITY_REVIEW] true -> eventually(<+MEASURE_DECISION_SUITABILITY> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SUITABILITY] true -> eventually(<+APPROVE_DECISION_SUITABILITY_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_appropriateness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_APPROPRIATENESS_REVIEW] true -> eventually(<+MEASURE_DECISION_APPROPRIATENESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_APPROPRIATENESS] true -> eventually(<+APPROVE_DECISION_APPROPRIATENESS_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_adequacy_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_ADEQUACY_REVIEW] true -> eventually(<+MEASURE_DECISION_ADEQUACY> true))"
                .to_string(),
            "always([+MEASURE_DECISION_ADEQUACY] true -> eventually(<+APPROVE_DECISION_ADEQUACY_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_sufficiency_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SUFFICIENCY_REVIEW] true -> eventually(<+MEASURE_DECISION_SUFFICIENCY> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SUFFICIENCY] true -> eventually(<+APPROVE_DECISION_SUFFICIENCY_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_completeness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_COMPLETENESS_REVIEW] true -> eventually(<+MEASURE_DECISION_COMPLETENESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_COMPLETENESS] true -> eventually(<+APPROVE_DECISION_COMPLETENESS_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_scope_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SCOPE_REVIEW] true -> eventually(<+MEASURE_DECISION_SCOPE> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SCOPE] true -> eventually(<+APPROVE_DECISION_SCOPE_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_range_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_RANGE_REVIEW] true -> eventually(<+MEASURE_DECISION_RANGE> true))"
                .to_string(),
            "always([+MEASURE_DECISION_RANGE] true -> eventually(<+APPROVE_DECISION_RANGE_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_bounds_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_BOUNDS_REVIEW] true -> eventually(<+MEASURE_DECISION_BOUNDS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_BOUNDS] true -> eventually(<+APPROVE_DECISION_BOUNDS_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_boundaries_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_BOUNDARIES_REVIEW] true -> eventually(<+MEASURE_DECISION_BOUNDARIES> true))"
                .to_string(),
            "always([+MEASURE_DECISION_BOUNDARIES] true -> eventually(<+APPROVE_DECISION_BOUNDARIES_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_criteria_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_CRITERIA_REVIEW] true -> eventually(<+MEASURE_DECISION_CRITERIA> true))"
                .to_string(),
            "always([+MEASURE_DECISION_CRITERIA] true -> eventually(<+APPROVE_DECISION_CRITERIA_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_conditions_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_CONDITIONS_REVIEW] true -> eventually(<+MEASURE_DECISION_CONDITIONS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_CONDITIONS] true -> eventually(<+APPROVE_DECISION_CONDITIONS_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_limits_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_LIMITS_REVIEW] true -> eventually(<+MEASURE_DECISION_LIMITS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_LIMITS] true -> eventually(<+APPROVE_DECISION_LIMITS_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_constraints_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_CONSTRAINTS_REVIEW] true -> eventually(<+MEASURE_DECISION_CONSTRAINTS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_CONSTRAINTS] true -> eventually(<+APPROVE_DECISION_CONSTRAINTS_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_restrictions_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_RESTRICTIONS_REVIEW] true -> eventually(<+MEASURE_DECISION_RESTRICTIONS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_RESTRICTIONS] true -> eventually(<+APPROVE_DECISION_RESTRICTIONS_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_requirements_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_REQUIREMENTS_REVIEW] true -> eventually(<+MEASURE_DECISION_REQUIREMENTS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_REQUIREMENTS] true -> eventually(<+APPROVE_DECISION_REQUIREMENTS_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_specifications_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SPECIFICATIONS_REVIEW] true -> eventually(<+MEASURE_DECISION_SPECIFICATIONS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SPECIFICATIONS] true -> eventually(<+APPROVE_DECISION_SPECIFICATIONS_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_parameters_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_PARAMETERS_REVIEW] true -> eventually(<+MEASURE_DECISION_PARAMETERS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_PARAMETERS] true -> eventually(<+APPROVE_DECISION_PARAMETERS_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_settings_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SETTINGS_REVIEW] true -> eventually(<+MEASURE_DECISION_SETTINGS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SETTINGS] true -> eventually(<+APPROVE_DECISION_SETTINGS_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_configuration_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_CONFIGURATION_REVIEW] true -> eventually(<+MEASURE_DECISION_CONFIGURATION> true))"
                .to_string(),
            "always([+MEASURE_DECISION_CONFIGURATION] true -> eventually(<+APPROVE_DECISION_CONFIGURATION_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_preference_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_PREFERENCE_REVIEW] true -> eventually(<+MEASURE_DECISION_PREFERENCE> true))"
                .to_string(),
            "always([+MEASURE_DECISION_PREFERENCE] true -> eventually(<+APPROVE_DECISION_PREFERENCE_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_option_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_OPTION_REVIEW] true -> eventually(<+MEASURE_DECISION_OPTION> true))"
                .to_string(),
            "always([+MEASURE_DECISION_OPTION] true -> eventually(<+APPROVE_DECISION_OPTION_REPORT> true))"
        ...
        let model =
            modality_lang::formula_synthesis::synthesize_from_formulas("DecisionOption", &formulas);

        verify_synthesized_model(&model, &formulas).unwrap();
    }

    #[test]
    fn verify_synthesized_model_accepts_decision_alternative_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_ALTERNATIVE_REVIEW] true -> eventually(<+MEASURE_DECISION_ALTERNATIVE> true))"
                .to_string(),
            "always([+MEASURE_DECISION_ALTERNATIVE] true -> eventually(<+APPROVE_DECISION_ALTERNATIVE_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_choice_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_CHOICE_REVIEW] true -> eventually(<+MEASURE_DECISION_CHOICE> true))"
                .to_string(),
            "always([+MEASURE_DECISION_CHOICE] true -> eventually(<+APPROVE_DECISION_CHOICE_REPORT> true))"
        ...
        let model =
            modality_lang::formula_synthesis::synthesize_from_formulas("DecisionChoice", &formulas);

        verify_synthesized_model(&model, &formulas).unwrap();
    }

    #[test]
    fn verify_synthesized_model_accepts_decision_selection_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SELECTION_REVIEW] true -> eventually(<+MEASURE_DECISION_SELECTION> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SELECTION] true -> eventually(<+APPROVE_DECISION_SELECTION_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_recommendation_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_RECOMMENDATION_REVIEW] true -> eventually(<+MEASURE_DECISION_RECOMMENDATION> true))"
                .to_string(),
            "always([+MEASURE_DECISION_RECOMMENDATION] true -> eventually(<+APPROVE_DECISION_RECOMMENDATION_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_proposal_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_PROPOSAL_REVIEW] true -> eventually(<+MEASURE_DECISION_PROPOSAL> true))"
                .to_string(),
            "always([+MEASURE_DECISION_PROPOSAL] true -> eventually(<+APPROVE_DECISION_PROPOSAL_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_submission_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SUBMISSION_REVIEW] true -> eventually(<+MEASURE_DECISION_SUBMISSION> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SUBMISSION] true -> eventually(<+APPROVE_DECISION_SUBMISSION_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_document_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_DOCUMENT_REVIEW] true -> eventually(<+MEASURE_DECISION_DOCUMENT> true))"
                .to_string(),
            "always([+MEASURE_DECISION_DOCUMENT] true -> eventually(<+APPROVE_DECISION_DOCUMENT_REPORT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_report_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_REPORT_REVIEW] true -> eventually(<+MEASURE_DECISION_REPORT> true))"
                .to_string(),
            "always([+MEASURE_DECISION_REPORT] true -> eventually(<+APPROVE_DECISION_REPORT> true))"
        ...
        let model =
            modality_lang::formula_synthesis::synthesize_from_formulas("DecisionReport", &formulas);

        verify_synthesized_model(&model, &formulas).unwrap();
    }

    #[test]
    fn verify_synthesized_model_accepts_decision_memo_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_MEMO_REVIEW] true -> eventually(<+MEASURE_DECISION_MEMO> true))"
                .to_string(),
            "always([+MEASURE_DECISION_MEMO] true -> eventually(<+APPROVE_DECISION_MEMO> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_minutes_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_MINUTES_REVIEW] true -> eventually(<+MEASURE_DECISION_MINUTES> true))"
                .to_string(),
            "always([+MEASURE_DECISION_MINUTES] true -> eventually(<+APPROVE_DECISION_MINUTES> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_transcript_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_TRANSCRIPT_REVIEW] true -> eventually(<+MEASURE_DECISION_TRANSCRIPT> true))"
                .to_string(),
            "always([+MEASURE_DECISION_TRANSCRIPT] true -> eventually(<+APPROVE_DECISION_TRANSCRIPT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_recording_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_RECORDING_REVIEW] true -> eventually(<+MEASURE_DECISION_RECORDING> true))"
                .to_string(),
            "always([+MEASURE_DECISION_RECORDING] true -> eventually(<+APPROVE_DECISION_RECORDING> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_catalog_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_CATALOG_REVIEW] true -> eventually(<+MEASURE_DECISION_CATALOG> true))"
                .to_string(),
            "always([+MEASURE_DECISION_CATALOG] true -> eventually(<+APPROVE_DECISION_CATALOG> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_inventory_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_INVENTORY_REVIEW] true -> eventually(<+MEASURE_DECISION_INVENTORY> true))"
                .to_string(),
            "always([+MEASURE_DECISION_INVENTORY] true -> eventually(<+APPROVE_DECISION_INVENTORY> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_registry_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_REGISTRY_REVIEW] true -> eventually(<+MEASURE_DECISION_REGISTRY> true))"
                .to_string(),
            "always([+MEASURE_DECISION_REGISTRY] true -> eventually(<+APPROVE_DECISION_REGISTRY> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_ledger_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_LEDGER_REVIEW] true -> eventually(<+MEASURE_DECISION_LEDGER> true))"
                .to_string(),
            "always([+MEASURE_DECISION_LEDGER] true -> eventually(<+APPROVE_DECISION_LEDGER> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_log_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_LOG_REVIEW] true -> eventually(<+MEASURE_DECISION_LOG> true))"
                .to_string(),
            "always([+MEASURE_DECISION_LOG] true -> eventually(<+APPROVE_DECISION_LOG> true))"
        ...
        let model =
            modality_lang::formula_synthesis::synthesize_from_formulas("DecisionLog", &formulas);

        verify_synthesized_model(&model, &formulas).unwrap();
    }

    #[test]
    fn verify_synthesized_model_accepts_decision_journal_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_JOURNAL_REVIEW] true -> eventually(<+MEASURE_DECISION_JOURNAL> true))"
                .to_string(),
            "always([+MEASURE_DECISION_JOURNAL] true -> eventually(<+APPROVE_DECISION_JOURNAL> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_timeline_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_TIMELINE_REVIEW] true -> eventually(<+MEASURE_DECISION_TIMELINE> true))"
                .to_string(),
            "always([+MEASURE_DECISION_TIMELINE] true -> eventually(<+APPROVE_DECISION_TIMELINE> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_docket_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_DOCKET_REVIEW] true -> eventually(<+MEASURE_DECISION_DOCKET> true))"
                .to_string(),
            "always([+MEASURE_DECISION_DOCKET] true -> eventually(<+APPROVE_DECISION_DOCKET> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_agenda_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_AGENDA_REVIEW] true -> eventually(<+MEASURE_DECISION_AGENDA> true))"
                .to_string(),
            "always([+MEASURE_DECISION_AGENDA] true -> eventually(<+APPROVE_DECISION_AGENDA> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_schedule_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SCHEDULE_REVIEW] true -> eventually(<+MEASURE_DECISION_SCHEDULE> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SCHEDULE] true -> eventually(<+APPROVE_DECISION_SCHEDULE> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_calendar_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_CALENDAR_REVIEW] true -> eventually(<+MEASURE_DECISION_CALENDAR> true))"
                .to_string(),
            "always([+MEASURE_DECISION_CALENDAR] true -> eventually(<+APPROVE_DECISION_CALENDAR> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_timetable_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_TIMETABLE_REVIEW] true -> eventually(<+MEASURE_DECISION_TIMETABLE> true))"
                .to_string(),
            "always([+MEASURE_DECISION_TIMETABLE] true -> eventually(<+APPROVE_DECISION_TIMETABLE> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_roadmap_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_ROADMAP_REVIEW] true -> eventually(<+MEASURE_DECISION_ROADMAP> true))"
                .to_string(),
            "always([+MEASURE_DECISION_ROADMAP] true -> eventually(<+APPROVE_DECISION_ROADMAP> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_plan_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_PLAN_REVIEW] true -> eventually(<+MEASURE_DECISION_PLAN> true))"
                .to_string(),
            "always([+MEASURE_DECISION_PLAN] true -> eventually(<+APPROVE_DECISION_PLAN> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_tactic_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_TACTIC_REVIEW] true -> eventually(<+MEASURE_DECISION_TACTIC> true))"
                .to_string(),
            "always([+MEASURE_DECISION_TACTIC] true -> eventually(<+APPROVE_DECISION_TACTIC> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_operation_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_OPERATION_REVIEW] true -> eventually(<+MEASURE_DECISION_OPERATION> true))"
                .to_string(),
            "always([+MEASURE_DECISION_OPERATION] true -> eventually(<+APPROVE_DECISION_OPERATION> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_execution_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_EXECUTION_REVIEW] true -> eventually(<+MEASURE_DECISION_EXECUTION> true))"
                .to_string(),
            "always([+MEASURE_DECISION_EXECUTION] true -> eventually(<+APPROVE_DECISION_EXECUTION> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_deployment_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_DEPLOYMENT_REVIEW] true -> eventually(<+MEASURE_DECISION_DEPLOYMENT> true))"
                .to_string(),
            "always([+MEASURE_DECISION_DEPLOYMENT] true -> eventually(<+APPROVE_DECISION_DEPLOYMENT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_rollout_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_ROLLOUT_REVIEW] true -> eventually(<+MEASURE_DECISION_ROLLOUT> true))"
                .to_string(),
            "always([+MEASURE_DECISION_ROLLOUT] true -> eventually(<+APPROVE_DECISION_ROLLOUT> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_adoption_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_ADOPTION_REVIEW] true -> eventually(<+MEASURE_DECISION_ADOPTION> true))"
                .to_string(),
            "always([+MEASURE_DECISION_ADOPTION] true -> eventually(<+APPROVE_DECISION_ADOPTION> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_launch_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_LAUNCH_REVIEW] true -> eventually(<+MEASURE_DECISION_LAUNCH> true))"
                .to_string(),
            "always([+MEASURE_DECISION_LAUNCH] true -> eventually(<+APPROVE_DECISION_LAUNCH> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_general_availability_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_GENERAL_AVAILABILITY_REVIEW] true -> eventually(<+MEASURE_DECISION_GENERAL_AVAILABILITY> true))"
                .to_string(),
            "always([+MEASURE_DECISION_GENERAL_AVAILABILITY] true -> eventually(<+APPROVE_DECISION_GENERAL_AVAILABILITY> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_production_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_PRODUCTION_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PRODUCTION_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_PRODUCTION_READINESS] true -> eventually(<+APPROVE_DECISION_PRODUCTION_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_operational_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_OPERATIONAL_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_OPERATIONAL_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_OPERATIONAL_READINESS] true -> eventually(<+APPROVE_DECISION_OPERATIONAL_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_service_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SERVICE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SERVICE_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SERVICE_READINESS] true -> eventually(<+APPROVE_DECISION_SERVICE_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_support_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SUPPORT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SUPPORT_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SUPPORT_READINESS] true -> eventually(<+APPROVE_DECISION_SUPPORT_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_customer_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_CUSTOMER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CUSTOMER_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_CUSTOMER_READINESS] true -> eventually(<+APPROVE_DECISION_CUSTOMER_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_stakeholder_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_STAKEHOLDER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_STAKEHOLDER_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_STAKEHOLDER_READINESS] true -> eventually(<+APPROVE_DECISION_STAKEHOLDER_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_partner_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_PARTNER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PARTNER_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_PARTNER_READINESS] true -> eventually(<+APPROVE_DECISION_PARTNER_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_market_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_MARKET_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MARKET_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_MARKET_READINESS] true -> eventually(<+APPROVE_DECISION_MARKET_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_sales_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SALES_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SALES_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SALES_READINESS] true -> eventually(<+APPROVE_DECISION_SALES_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_revenue_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_REVENUE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_REVENUE_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_REVENUE_READINESS] true -> eventually(<+APPROVE_DECISION_REVENUE_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_margin_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_MARGIN_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MARGIN_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_MARGIN_READINESS] true -> eventually(<+APPROVE_DECISION_MARGIN_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_profit_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_PROFIT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PROFIT_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_PROFIT_READINESS] true -> eventually(<+APPROVE_DECISION_PROFIT_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_cost_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_COST_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_COST_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_COST_READINESS] true -> eventually(<+APPROVE_DECISION_COST_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_value_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_VALUE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_VALUE_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_VALUE_READINESS] true -> eventually(<+APPROVE_DECISION_VALUE_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_growth_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_GROWTH_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_GROWTH_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_GROWTH_READINESS] true -> eventually(<+APPROVE_DECISION_GROWTH_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_pipeline_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_PIPELINE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PIPELINE_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_PIPELINE_READINESS] true -> eventually(<+APPROVE_DECISION_PIPELINE_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_forecast_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_FORECAST_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_FORECAST_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_FORECAST_READINESS] true -> eventually(<+APPROVE_DECISION_FORECAST_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_demand_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_DEMAND_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_DEMAND_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_DEMAND_READINESS] true -> eventually(<+APPROVE_DECISION_DEMAND_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_capacity_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_CAPACITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CAPACITY_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_CAPACITY_READINESS] true -> eventually(<+APPROVE_DECISION_CAPACITY_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_supply_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SUPPLY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SUPPLY_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SUPPLY_READINESS] true -> eventually(<+APPROVE_DECISION_SUPPLY_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_logistics_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_LOGISTICS_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_LOGISTICS_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_LOGISTICS_READINESS] true -> eventually(<+APPROVE_DECISION_LOGISTICS_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_fulfillment_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_FULFILLMENT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_FULFILLMENT_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_FULFILLMENT_READINESS] true -> eventually(<+APPROVE_DECISION_FULFILLMENT_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_delivery_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_DELIVERY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_DELIVERY_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_DELIVERY_READINESS] true -> eventually(<+APPROVE_DECISION_DELIVERY_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_distribution_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_DISTRIBUTION_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_DISTRIBUTION_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_DISTRIBUTION_READINESS] true -> eventually(<+APPROVE_DECISION_DISTRIBUTION_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_channel_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_CHANNEL_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CHANNEL_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_CHANNEL_READINESS] true -> eventually(<+APPROVE_DECISION_CHANNEL_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_segment_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SEGMENT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SEGMENT_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SEGMENT_READINESS] true -> eventually(<+APPROVE_DECISION_SEGMENT_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_territory_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_TERRITORY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_TERRITORY_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_TERRITORY_READINESS] true -> eventually(<+APPROVE_DECISION_TERRITORY_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_account_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_ACCOUNT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ACCOUNT_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_ACCOUNT_READINESS] true -> eventually(<+APPROVE_DECISION_ACCOUNT_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_opportunity_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_OPPORTUNITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_OPPORTUNITY_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_OPPORTUNITY_READINESS] true -> eventually(<+APPROVE_DECISION_OPPORTUNITY_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_deal_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_DEAL_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_DEAL_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_DEAL_READINESS] true -> eventually(<+APPROVE_DECISION_DEAL_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_quote_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_QUOTE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_QUOTE_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_QUOTE_READINESS] true -> eventually(<+APPROVE_DECISION_QUOTE_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_contract_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_CONTRACT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CONTRACT_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_CONTRACT_READINESS] true -> eventually(<+APPROVE_DECISION_CONTRACT_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_proposal_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_PROPOSAL_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PROPOSAL_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_PROPOSAL_READINESS] true -> eventually(<+APPROVE_DECISION_PROPOSAL_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_bid_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_BID_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_BID_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_BID_READINESS] true -> eventually(<+APPROVE_DECISION_BID_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_tender_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_TENDER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_TENDER_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_TENDER_READINESS] true -> eventually(<+APPROVE_DECISION_TENDER_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_procurement_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_PROCUREMENT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PROCUREMENT_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_PROCUREMENT_READINESS] true -> eventually(<+APPROVE_DECISION_PROCUREMENT_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_sourcing_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SOURCING_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SOURCING_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SOURCING_READINESS] true -> eventually(<+APPROVE_DECISION_SOURCING_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_supplier_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SUPPLIER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SUPPLIER_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SUPPLIER_READINESS] true -> eventually(<+APPROVE_DECISION_SUPPLIER_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_vendor_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_VENDOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_VENDOR_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_VENDOR_READINESS] true -> eventually(<+APPROVE_DECISION_VENDOR_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_contractor_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_CONTRACTOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CONTRACTOR_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_CONTRACTOR_READINESS] true -> eventually(<+APPROVE_DECISION_CONTRACTOR_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_consultant_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_CONSULTANT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CONSULTANT_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_CONSULTANT_READINESS] true -> eventually(<+APPROVE_DECISION_CONSULTANT_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_advisor_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_ADVISOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ADVISOR_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_ADVISOR_READINESS] true -> eventually(<+APPROVE_DECISION_ADVISOR_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_expert_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_EXPERT_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_EXPERT_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_EXPERT_READINESS] true -> eventually(<+APPROVE_DECISION_EXPERT_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_specialist_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SPECIALIST_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SPECIALIST_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SPECIALIST_READINESS] true -> eventually(<+APPROVE_DECISION_SPECIALIST_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_practitioner_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_PRACTITIONER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PRACTITIONER_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_PRACTITIONER_READINESS] true -> eventually(<+APPROVE_DECISION_PRACTITIONER_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_technician_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_TECHNICIAN_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_TECHNICIAN_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_TECHNICIAN_READINESS] true -> eventually(<+APPROVE_DECISION_TECHNICIAN_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_engineer_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_ENGINEER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ENGINEER_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_ENGINEER_READINESS] true -> eventually(<+APPROVE_DECISION_ENGINEER_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_operator_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_OPERATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_OPERATOR_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_OPERATOR_READINESS] true -> eventually(<+APPROVE_DECISION_OPERATOR_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_analyst_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_ANALYST_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ANALYST_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_ANALYST_READINESS] true -> eventually(<+APPROVE_DECISION_ANALYST_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_coordinator_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_COORDINATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_COORDINATOR_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_COORDINATOR_READINESS] true -> eventually(<+APPROVE_DECISION_COORDINATOR_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_facilitator_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_FACILITATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_FACILITATOR_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_FACILITATOR_READINESS] true -> eventually(<+APPROVE_DECISION_FACILITATOR_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_mediator_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_MEDIATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MEDIATOR_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_MEDIATOR_READINESS] true -> eventually(<+APPROVE_DECISION_MEDIATOR_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_arbitrator_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_ARBITRATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ARBITRATOR_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_ARBITRATOR_READINESS] true -> eventually(<+APPROVE_DECISION_ARBITRATOR_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_judge_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_JUDGE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_JUDGE_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_JUDGE_READINESS] true -> eventually(<+APPROVE_DECISION_JUDGE_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_magistrate_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_MAGISTRATE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MAGISTRATE_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_MAGISTRATE_READINESS] true -> eventually(<+APPROVE_DECISION_MAGISTRATE_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_adjudicator_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_ADJUDICATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ADJUDICATOR_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_ADJUDICATOR_READINESS] true -> eventually(<+APPROVE_DECISION_ADJUDICATOR_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_ombudsman_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_OMBUDSMAN_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_OMBUDSMAN_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_OMBUDSMAN_READINESS] true -> eventually(<+APPROVE_DECISION_OMBUDSMAN_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_referee_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_REFEREE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_REFEREE_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_REFEREE_READINESS] true -> eventually(<+APPROVE_DECISION_REFEREE_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_umpire_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_UMPIRE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_UMPIRE_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_UMPIRE_READINESS] true -> eventually(<+APPROVE_DECISION_UMPIRE_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_moderator_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_MODERATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MODERATOR_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_MODERATOR_READINESS] true -> eventually(<+APPROVE_DECISION_MODERATOR_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_reviewer_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_REVIEWER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_REVIEWER_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_REVIEWER_READINESS] true -> eventually(<+APPROVE_DECISION_REVIEWER_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_assessor_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_ASSESSOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ASSESSOR_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_ASSESSOR_READINESS] true -> eventually(<+APPROVE_DECISION_ASSESSOR_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_evaluator_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_EVALUATOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_EVALUATOR_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_EVALUATOR_READINESS] true -> eventually(<+APPROVE_DECISION_EVALUATOR_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_auditor_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_AUDITOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_AUDITOR_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_AUDITOR_READINESS] true -> eventually(<+APPROVE_DECISION_AUDITOR_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_inspector_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_INSPECTOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_INSPECTOR_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_INSPECTOR_READINESS] true -> eventually(<+APPROVE_DECISION_INSPECTOR_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_examiner_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_EXAMINER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_EXAMINER_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_EXAMINER_READINESS] true -> eventually(<+APPROVE_DECISION_EXAMINER_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_monitor_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_MONITOR_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MONITOR_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_MONITOR_READINESS] true -> eventually(<+APPROVE_DECISION_MONITOR_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_observer_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_OBSERVER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_OBSERVER_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_OBSERVER_READINESS] true -> eventually(<+APPROVE_DECISION_OBSERVER_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_watcher_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_WATCHER_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_WATCHER_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_WATCHER_READINESS] true -> eventually(<+APPROVE_DECISION_WATCHER_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_sentinel_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SENTINEL_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SENTINEL_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SENTINEL_READINESS] true -> eventually(<+APPROVE_DECISION_SENTINEL_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_guardian_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_GUARDIAN_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_GUARDIAN_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_GUARDIAN_READINESS] true -> eventually(<+APPROVE_DECISION_GUARDIAN_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_custodian_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_CUSTODIAN_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_CUSTODIAN_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_CUSTODIAN_READINESS] true -> eventually(<+APPROVE_DECISION_CUSTODIAN_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_steward_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_STEWARD_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_STEWARD_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_STEWARD_READINESS] true -> eventually(<+APPROVE_DECISION_STEWARD_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_trustee_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_TRUSTEE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_TRUSTEE_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_TRUSTEE_READINESS] true -> eventually(<+APPROVE_DECISION_TRUSTEE_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_fiduciary_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_FIDUCIARY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_FIDUCIARY_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_FIDUCIARY_READINESS] true -> eventually(<+APPROVE_DECISION_FIDUCIARY_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_compliance_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_COMPLIANCE_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_COMPLIANCE_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_COMPLIANCE_READINESS] true -> eventually(<+APPROVE_DECISION_COMPLIANCE_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_risk_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_RISK_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_RISK_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_RISK_READINESS] true -> eventually(<+APPROVE_DECISION_RISK_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_safety_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SAFETY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SAFETY_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SAFETY_READINESS] true -> eventually(<+APPROVE_DECISION_SAFETY_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_security_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SECURITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SECURITY_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SECURITY_READINESS] true -> eventually(<+APPROVE_DECISION_SECURITY_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_privacy_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_PRIVACY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PRIVACY_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_PRIVACY_READINESS] true -> eventually(<+APPROVE_DECISION_PRIVACY_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_data_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_DATA_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_DATA_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_DATA_READINESS] true -> eventually(<+APPROVE_DECISION_DATA_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_ai_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_AI_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_AI_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_AI_READINESS] true -> eventually(<+APPROVE_DECISION_AI_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_ml_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_ML_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ML_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_ML_READINESS] true -> eventually(<+APPROVE_DECISION_ML_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_model_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_MODEL_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MODEL_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_MODEL_READINESS] true -> eventually(<+APPROVE_DECISION_MODEL_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_algorithm_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_ALGORITHM_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_ALGORITHM_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_ALGORITHM_READINESS] true -> eventually(<+APPROVE_DECISION_ALGORITHM_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_automation_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_AUTOMATION_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_AUTOMATION_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_AUTOMATION_READINESS] true -> eventually(<+APPROVE_DECISION_AUTOMATION_READINESS> true))"
    ...
    fn verify_synthesized_model_accepts_decision_orchestration_readiness_ordering_prompt_examples() {
        ...
        let model = modality_lang::formula_synthesis::synthesize_from_formulas(
            "DecisionOrchestrationReadiness",
            &formulas,
        );
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_coordination_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_COORDINATION_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_COORDINATION_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_COORDINATION_READINESS] true -> eventually(<+APPROVE_DECISION_COORDINATION_READINESS> true))"
    ...
    fn verify_synthesized_model_accepts_decision_collaboration_readiness_ordering_prompt_examples() {
        ...
        let model = modality_lang::formula_synthesis::synthesize_from_formulas(
            "DecisionCollaborationReadiness",
            &formulas,
        );
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_integration_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_INTEGRATION_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_INTEGRATION_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_INTEGRATION_READINESS] true -> eventually(<+APPROVE_DECISION_INTEGRATION_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_interoperability_readiness_ordering_prompt_examples(
    ) {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_INTEROPERABILITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_INTEROPERABILITY_READINESS> true))"
                .to_string(),
        ...
        let model = modality_lang::formula_synthesis::synthesize_from_formulas(
            "DecisionInteroperabilityReadiness",
            &formulas,
        );
    ...
    fn verify_synthesized_model_accepts_decision_compatibility_readiness_ordering_prompt_examples() {
        ...
        let model = modality_lang::formula_synthesis::synthesize_from_formulas(
            "DecisionCompatibilityReadiness",
            &formulas,
        );
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_portability_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_PORTABILITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_PORTABILITY_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_PORTABILITY_READINESS] true -> eventually(<+APPROVE_DECISION_PORTABILITY_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_transferability_readiness_ordering_prompt_examples(
    ) {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_TRANSFERABILITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_TRANSFERABILITY_READINESS> true))"
                .to_string(),
        ...
        let model = modality_lang::formula_synthesis::synthesize_from_formulas(
            "DecisionTransferabilityReadiness",
            &formulas,
        );
    ...
    fn verify_synthesized_model_accepts_decision_assignability_readiness_ordering_prompt_examples(
        ...
        let model = modality_lang::formula_synthesis::synthesize_from_formulas(
            "DecisionAssignabilityReadiness",
            &formulas,
        );
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_mobility_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_MOBILITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_MOBILITY_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_MOBILITY_READINESS] true -> eventually(<+APPROVE_DECISION_MOBILITY_READINESS> true))"
    ...
    #[test]
    fn verify_synthesized_model_accepts_decision_scalability_readiness_ordering_prompt_examples() {
        let formulas = parse_formula_strings(&[
            "always([+REQUEST_DECISION_SCALABILITY_READINESS_REVIEW] true -> eventually(<+MEASURE_DECISION_SCALABILITY_READINESS> true))"
                .to_string(),
            "always([+MEASURE_DECISION_SCALABILITY_READINESS] true -> eventually(<+APPROVE_DECISION_SCALABILITY_READINESS> true))"
