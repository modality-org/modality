...
//     use modal_datastore::models::validator::block::Block;
//     use modal_validator_consensus::sequencing::static_authority::StaticAuthority;
//     use modal_validator_consensus::election;
//     use modal_validator_consensus::runner::*;
//     use std::sync::Arc;
...
//         // // Process acks
//         let ack= runner1.on_receive_draft_block(&block).await?;
//         runner1.on_receive_block_ack(ack).await?;

//         let ack = runner2.on_receive_draft_block(&block).await?;
//         runner1.on_receive_block_ack(ack).await?;

//         let ack = runner3.on_receive_draft_block(&block).await?;
//         runner1.on_receive_block_ack(ack).await?;
...
//         //     .on_receive_certified_block(&block)
//         //     .await?;
