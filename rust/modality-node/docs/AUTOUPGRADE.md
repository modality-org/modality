...
```json
{
  ...
  "autoupgrade_base_url": "https://get.modality.org",
...
- **`autoupgrade_base_url`** (optional, string): The base URL of the package server. Default: `https://get.modality.org`
...
{
  "autoupgrade_enabled": true,
  "autoupgrade_registry_url": "https://get.modality.org/testnet/latest/cargo-registry/index/"
}
```
