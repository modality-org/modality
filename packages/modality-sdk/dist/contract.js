...
import { signJSON, verifyJSON } from './identity.js';
...
export function createContract(intent, creator) {
...
export function verifyGenesis(genesis) {
    const { signature, signer, ...payload } = genesis;
    return verifyJSON(payload, signature, signer);
}
/** Create a new commit */
export function createCommit(contractId, sequence, actions, parentHash) {
    return {
...
export function signCommit(commit, identity) {
