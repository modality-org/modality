...
if [ ! -f "./tmp/node2/config.json" ]; then
    ...
    modal node create \
        ...
        --bootstrappers "/ip4/127.0.0.1/tcp/10301/ws/p2p/12D3KooWA7csjq5MQyPWA4R7R5jRMf8RwhnSjXNNY3fF2jH2uxK3,/ip4/127.0.0.1/tcp/10303/ws/p2p/12D3KooW9qGaMuW7k2a5iEQ37gWgtjfFC4B3j5R1kKJPZofS62Se"
fi
