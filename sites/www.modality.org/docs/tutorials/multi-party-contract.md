...
This creates:
- `~/.modality/passfiles/alice.mod_passfile`
- `~/.modality/passfiles/bob.mod_passfile`
- `~/.modality/ids/alice.id`
- `~/.modality/ids/bob.id`

:::tip
Named passfiles are stored in `~/.modality/passfiles/` by default — never in the contract directory!
:::
