...
- `~/.modality/passfiles/example/alice.mod_passfile` — private key
- `~/.modality/ids/example/alice.id` — public ID only
...
5. **Keep named passfiles out of the contract directory** — store them under `~/.modality/passfiles/`
