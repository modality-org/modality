...
# Deploy script for start.modal.money infrastructure
# This script helps deploy the AWS CDK infrastructure for start.modal.money
...
echo "================================================"
echo "start.modal.money Infrastructure Deployment"
echo "================================================"
echo ""
