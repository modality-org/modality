...
# Build Cargo Registry for get.modality.org
# This script creates a proper sparse registry with all workspace packages

set -e

# Get the project root (assuming this script is in sites/get.modality.org/)
...
{
    "dl": "https://get.modality.org/testnet/latest/cargo-registry/{crate}-{version}.crate",
    "api": "https://get.modality.org/testnet/latest/cargo-registry/"
}
EOF
...
cat >> "$REGISTRY_DIR/index.html" << 'EOF_MAIN2'
        ...
        <div class="install-section">
            ...
            <pre>curl -fsSL https://get.modality.org/testnet/latest/install.sh | sh</pre>
            <p>Supports: Linux x86_64 • macOS Apple Silicon</p>
            
            <h3>Option 2: Direct Download</h3>
            <p>Download binaries directly:</p>
            <ul>
                <li><a href="https://get.modality.org/testnet/latest/binaries/linux-x86_64/modality">Linux x86_64</a></li>
                <li><a href="https://get.modality.org/testnet/latest/binaries/darwin-aarch64/modality">macOS Apple Silicon</a></li>
            </ul>
        </div>
        ...
        <div class="install-section">
            ...
            <pre>cargo install --index sparse+https://get.modality.org/testnet/latest/cargo-registry/index/ modality</pre>
        </div>
        
        <h2>Registry Configuration</h2>
        <p>Add to <code>~/.cargo/config.toml</code>:</p>
        <pre>[registries.modality]
index = "sparse+https://get.modality.org/testnet/latest/cargo-registry/index/"</pre>
